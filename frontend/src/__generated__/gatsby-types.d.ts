...
type WpTag = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpMenuItemLinkable & {
  ...
  readonly events: Maybe<WpTagToEventConnection>;
  readonly id: Scalars['ID'];
  /** Whether the node is a Content Node */
  readonly isContentNode: Scalars['Boolean'];
  /** Whether the node is a Term */
  ...
  /** The human friendly name of the object. */
  readonly name: Maybe<Scalars['String']>;
  /** Connection between the tag type and the NewsItem type */
  readonly newsItems: Maybe<WpTagToNewsItemConnection>;
...
type WpTagToEventConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpEvent>>>;
};

/** The Event type */
type WpEvent = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpNodeWithContentEditor & WpNodeWithFeaturedImage & WpNodeWithExcerpt & WpNodeWithPageAttributes & WpHierarchicalContentNode & WpMenuItemLinkable & {
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  readonly ancestors: Maybe<WpHierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the HierarchicalContentNode type and the ContentNode type */
  readonly wpChildren: Maybe<WpHierarchicalContentNodeToContentNodeChildrenConnection>;
  ...
  /** The RSS enclosure for the object */
  readonly enclosure: Maybe<Scalars['String']>;
  /** Connection between the Event type and the EventCategory type */
  readonly eventCategories: Maybe<WpEventToEventCategoryConnection>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Event Informations&quot; was set to Show in GraphQL. */
  readonly eventInformations: Maybe<WpEvent_Eventinformations>;
  /** The excerpt of the post. */
  readonly excerpt: Maybe<Scalars['String']>;
  /** Connection between the NodeWithFeaturedImage type and the MediaItem type */
  readonly featuredImage: Maybe<WpNodeWithFeaturedImageToMediaItemConnectionEdge>;
  ...
  readonly tags: Maybe<WpEventToTagConnection>;
  /** The template assigned to a node of content */
  readonly template: Maybe<WpContentTemplate>;
  /** Connection between the Event type and the TermNode type */
  readonly terms: Maybe<WpEventToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
  /** The unique resource identifier path */
  readonly uri: Maybe<Scalars['String']>;
...
/** Connection between the Event type and the EventCategory type */
type WpEventToEventCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpEventCategory>>>;
};

/** The EventCategory type */
type WpEventCategory = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpHierarchicalTermNode & WpMenuItemLinkable & {
  /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  readonly ancestors: Maybe<WpEventCategoryToAncestorsEventCategoryConnection>;
  /** Connection between the EventCategory type and the EventCategory type */
  readonly wpChildren: Maybe<WpEventCategoryToEventCategoryConnection>;
  /** Connection between the EventCategory type and the ContentNode type */
  readonly contentNodes: Maybe<WpEventCategoryToContentNodeConnection>;
  /** The number of objects connected to the object */
  readonly count: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  readonly databaseId: Scalars['Int'];
  /** The description of the object */
  readonly description: Maybe<Scalars['String']>;
  /** Connection between the EventCategory type and the Event type */
  readonly events: Maybe<WpEventCategoryToEventConnection>;
  readonly id: Scalars['ID'];
  /** Whether the node is a Content Node */
  readonly isContentNode: Scalars['Boolean'];
  /** Whether the node is a Term */
  ...
  readonly name: Maybe<Scalars['String']>;
  /** Connection between the EventCategory type and the EventCategory type */
  readonly wpParent: Maybe<WpEventCategoryToParentEventCategoryConnectionEdge>;
  /** Database id of the parent node */
  readonly parentDatabaseId: Maybe<Scalars['Int']>;
  /** The globally unique identifier of the parent node. */
  readonly parentId: Maybe<Scalars['ID']>;
  /** An alphanumeric identifier for the object unique to its type. */
  readonly slug: Maybe<Scalars['String']>;
  /** Connection between the EventCategory type and the Taxonomy type */
  readonly taxonomy: Maybe<WpEventCategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  readonly taxonomyName: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  readonly termGroupId: Maybe<Scalars['Int']>;
...
/** Connection between the EventCategory type and the EventCategory type */
type WpEventCategoryToAncestorsEventCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpEventCategory>>>;
};

/** Connection between the EventCategory type and the EventCategory type */
type WpEventCategoryToEventCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpEventCategory>>>;
};

/** Connection between the EventCategory type and the ContentNode type */
type WpEventCategoryToContentNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContentNode>>>;
};

/** Connection between the EventCategory type and the Event type */
type WpEventCategoryToEventConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpEvent>>>;
};

/** Connection between the EventCategory type and the EventCategory type */
type WpEventCategoryToParentEventCategoryConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpEventCategory>;
};

/** Connection between the EventCategory type and the Taxonomy type */
type WpEventCategoryToTaxonomyConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpTaxonomy>;
};

/** Field Group */
type WpEvent_Eventinformations = WpAcfFieldGroup & {
  readonly contactPerson: Maybe<ReadonlyArray<Maybe<WpEvent_Eventinformations_ContactPerson>>>;
...
type WpEvent_Eventinformations_ContactPerson = WpContact;

/** Connection between the Contact type and the ContactCategory type */
type WpContactToContactCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContactCategory>>>;
};

/** The ContactCategory type */
type WpContactCategory = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpMenuItemLinkable & {
  /** Connection between the ContactCategory type and the Contact type */
  readonly contacts: Maybe<WpContactCategoryToContactConnection>;
  /** Connection between the ContactCategory type and the ContentNode type */
  readonly contentNodes: Maybe<WpContactCategoryToContentNodeConnection>;
  /** The number of objects connected to the object */
  readonly count: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  readonly databaseId: Scalars['Int'];
  ...
  /** An alphanumeric identifier for the object unique to its type. */
  readonly slug: Maybe<Scalars['String']>;
  /** Connection between the ContactCategory type and the Taxonomy type */
  readonly taxonomy: Maybe<WpContactCategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  readonly taxonomyName: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  readonly termGroupId: Maybe<Scalars['Int']>;
...
/** Connection between the ContactCategory type and the Contact type */
type WpContactCategoryToContactConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContact>>>;
};

/** Connection between the ContactCategory type and the ContentNode type */
type WpContactCategoryToContentNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContentNode>>>;
};

/** Connection between the ContactCategory type and the Taxonomy type */
type WpContactCategoryToTaxonomyConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpTaxonomy>;
};

/** Field Group */
type WpContact_Contactinformations = WpAcfFieldGroup & {
  readonly email: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  readonly fieldGroupName: Maybe<Scalars['String']>;
  readonly firstName: Maybe<Scalars['String']>;
  readonly lastName: Maybe<Scalars['String']>;
  readonly organization: Maybe<ReadonlyArray<Maybe<WpContact_Contactinformations_Organization>>>;
  readonly phone: Maybe<Scalars['String']>;
  readonly photo: Maybe<WpMediaItem>;
  readonly position: Maybe<Scalars['String']>;
  readonly title: Maybe<Scalars['String']>;
};

type WpContact_Contactinformations_Organization = WpOrganization;

/** Connection between the Organization type and the OrganizationCategory type */
type WpOrganizationToOrganizationCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpOrganizationCategory>>>;
};

/** The OrganizationCategory type */
type WpOrganizationCategory = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpMenuItemLinkable & {
  /** Connection between the OrganizationCategory type and the ContentNode type */
  readonly contentNodes: Maybe<WpOrganizationCategoryToContentNodeConnection>;
  /** The number of objects connected to the object */
  readonly count: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  readonly databaseId: Scalars['Int'];
  ...
  /** The human friendly name of the object. */
  readonly name: Maybe<Scalars['String']>;
  /** Connection between the OrganizationCategory type and the Organization type */
  readonly organizations: Maybe<WpOrganizationCategoryToOrganizationConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  readonly slug: Maybe<Scalars['String']>;
  /** Connection between the OrganizationCategory type and the Taxonomy type */
  readonly taxonomy: Maybe<WpOrganizationCategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  readonly taxonomyName: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  readonly termGroupId: Maybe<Scalars['Int']>;
...
/** Connection between the OrganizationCategory type and the ContentNode type */
type WpOrganizationCategoryToContentNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContentNode>>>;
};

/** Connection between the OrganizationCategory type and the Organization type */
type WpOrganizationCategoryToOrganizationConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpOrganization>>>;
};

/** Connection between the OrganizationCategory type and the Taxonomy type */
type WpOrganizationCategoryToTaxonomyConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpTaxonomy>;
};

/** Field Group */
type WpOrganization_Organizationinformations = WpAcfFieldGroup & {
  readonly description: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  readonly fieldGroupName: Maybe<Scalars['String']>;
...
/** Connection between the Organization type and the TermNode type */
type WpOrganizationToTermNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpTermNode>>>;
};

/** Connection between the Contact type and the TermNode type */
type WpContactToTermNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpTermNode>>>;
};
...
/** Connection between the tag type and the NewsItem type */
type WpTagToNewsItemConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpNewsItem>>>;
};

/** The NewsItem type */
type WpNewsItem = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpNodeWithContentEditor & WpNodeWithFeaturedImage & WpNodeWithExcerpt & WpMenuItemLinkable & {
  /** News Attachments */
  readonly attachments: Maybe<ReadonlyArray<Maybe<WpAttachment>>>;
  /** The content of the post. */
  readonly content: Maybe<Scalars['String']>;
  /** Connection between the ContentNode type and the ContentType type */
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdge>;
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  readonly modifiedGmt: Maybe<Scalars['Date']>;
  /** Connection between the NewsItem type and the NewsCategory type */
  readonly newsCategories: Maybe<WpNewsItemToNewsCategoryConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  readonly slug: Maybe<Scalars['String']>;
  /** The current status of the object */
  readonly status: Maybe<Scalars['String']>;
  /** Connection between the NewsItem type and the tag type */
  readonly tags: Maybe<WpNewsItemToTagConnection>;
  /** The template assigned to a node of content */
  readonly template: Maybe<WpContentTemplate>;
  /** Connection between the NewsItem type and the TermNode type */
  readonly terms: Maybe<WpNewsItemToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
  /** The unique resource identifier path */
  readonly uri: Maybe<Scalars['String']>;
...
/** The NewsItem type */
type WpNewsItem_modifiedGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type WpAttachment = {
  readonly fileSizeHumanReadable: Maybe<Scalars['String']>;
...
/** Connection between the NewsItem type and the NewsCategory type */
type WpNewsItemToNewsCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpNewsCategory>>>;
};

/** The NewsCategory type */
type WpNewsCategory = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpHierarchicalTermNode & WpMenuItemLinkable & {
  /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  readonly ancestors: Maybe<WpNewsCategoryToAncestorsNewsCategoryConnection>;
  /** Connection between the NewsCategory type and the NewsCategory type */
  readonly wpChildren: Maybe<WpNewsCategoryToNewsCategoryConnection>;
  /** Connection between the NewsCategory type and the ContentNode type */
  readonly contentNodes: Maybe<WpNewsCategoryToContentNodeConnection>;
  /** The number of objects connected to the object */
  readonly count: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  readonly databaseId: Scalars['Int'];
  ...
  /** The human friendly name of the object. */
  readonly name: Maybe<Scalars['String']>;
  /** Connection between the NewsCategory type and the NewsItem type */
  readonly newsItems: Maybe<WpNewsCategoryToNewsItemConnection>;
  /** Connection between the NewsCategory type and the NewsCategory type */
  readonly wpParent: Maybe<WpNewsCategoryToParentNewsCategoryConnectionEdge>;
  /** Database id of the parent node */
  readonly parentDatabaseId: Maybe<Scalars['Int']>;
  /** The globally unique identifier of the parent node. */
  readonly parentId: Maybe<Scalars['ID']>;
  /** An alphanumeric identifier for the object unique to its type. */
  readonly slug: Maybe<Scalars['String']>;
  /** Connection between the NewsCategory type and the Taxonomy type */
  readonly taxonomy: Maybe<WpNewsCategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  readonly taxonomyName: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  readonly termGroupId: Maybe<Scalars['Int']>;
...
/** Connection between the NewsCategory type and the NewsCategory type */
type WpNewsCategoryToAncestorsNewsCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpNewsCategory>>>;
};

/** Connection between the NewsCategory type and the NewsCategory type */
type WpNewsCategoryToNewsCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpNewsCategory>>>;
};

/** Connection between the NewsCategory type and the ContentNode type */
type WpNewsCategoryToContentNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContentNode>>>;
};

/** Connection between the NewsCategory type and the NewsItem type */
type WpNewsCategoryToNewsItemConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpNewsItem>>>;
};

/** Connection between the NewsCategory type and the NewsCategory type */
type WpNewsCategoryToParentNewsCategoryConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpNewsCategory>;
};

/** Connection between the NewsCategory type and the Taxonomy type */
type WpNewsCategoryToTaxonomyConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpTaxonomy>;
};

/** Connection between the NewsItem type and the tag type */
type WpNewsItemToTagConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpTag>>>;
};

/** Connection between the NewsItem type and the TermNode type */
type WpNewsItemToTermNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpTermNode>>>;
};
...
/** The LinkTreeItem type */
type WpLinkTreeItem = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpNodeWithFeaturedImage & WpMenuItemLinkable & {
  /** Connection between the ContentNode type and the ContentType type */
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  readonly contentTypeName: Scalars['String'];
  ...
  /** The permalink of the post */
  readonly link: Maybe<Scalars['String']>;
  /** Connection between the LinkTreeItem type and the LinkTreeItemCategory type */
  readonly linkTreeItemCategories: Maybe<WpLinkTreeItemToLinkTreeItemCategoryConnection>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Link Tree Item Information&quot; was set to Show in GraphQL. */
  readonly linkTreeItemInformation: Maybe<WpLinkTreeItem_Linktreeiteminformation>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  readonly modified: Maybe<Scalars['Date']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  readonly modifiedGmt: Maybe<Scalars['Date']>;
  ...
  /** The template assigned to a node of content */
  readonly template: Maybe<WpContentTemplate>;
  /** Connection between the LinkTreeItem type and the TermNode type */
  readonly terms: Maybe<WpLinkTreeItemToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
  /** The unique resource identifier path */
  readonly uri: Maybe<Scalars['String']>;
...
/** The LinkTreeItem type */
type WpLinkTreeItem_dateGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
/** The LinkTreeItem type */
type WpLinkTreeItem_modifiedArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
/** The LinkTreeItem type */
type WpLinkTreeItem_modifiedGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
/** Connection between the LinkTreeItem type and the LinkTreeItemCategory type */
type WpLinkTreeItemToLinkTreeItemCategoryConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpLinkTreeItemCategory>>>;
};

/** The LinkTreeItemCategory type */
type WpLinkTreeItemCategory = Node & WpNode & WpTermNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpMenuItemLinkable & {
  /** Connection between the LinkTreeItemCategory type and the ContentNode type */
  readonly contentNodes: Maybe<WpLinkTreeItemCategoryToContentNodeConnection>;
  /** The number of objects connected to the object */
  readonly count: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  readonly databaseId: Scalars['Int'];
  ...
  /** The link to the term */
  readonly link: Maybe<Scalars['String']>;
  /** Connection between the LinkTreeItemCategory type and the LinkTreeItem type */
  readonly linkTreeItems: Maybe<WpLinkTreeItemCategoryToLinkTreeItemConnection>;
  /** The human friendly name of the object. */
  readonly name: Maybe<Scalars['String']>;
  /** An alphanumeric identifier for the object unique to its type. */
  readonly slug: Maybe<Scalars['String']>;
  /** Connection between the LinkTreeItemCategory type and the Taxonomy type */
  readonly taxonomy: Maybe<WpLinkTreeItemCategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  readonly taxonomyName: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  readonly termGroupId: Maybe<Scalars['Int']>;
...
/** Connection between the LinkTreeItemCategory type and the ContentNode type */
type WpLinkTreeItemCategoryToContentNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpContentNode>>>;
};

/** Connection between the LinkTreeItemCategory type and the LinkTreeItem type */
type WpLinkTreeItemCategoryToLinkTreeItemConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpLinkTreeItem>>>;
};

/** Connection between the LinkTreeItemCategory type and the Taxonomy type */
type WpLinkTreeItemCategoryToTaxonomyConnectionEdge = {
  /** The node of the connection, without the edges */
  readonly node: Maybe<WpTaxonomy>;
};

/** Field Group */
type WpLinkTreeItem_Linktreeiteminformation = WpAcfFieldGroup & {
  readonly category: Maybe<WpLinkTreeItemCategory>;
  /** The name of the ACF Field Group */
  readonly fieldGroupName: Maybe<Scalars['String']>;
  readonly url: Maybe<Scalars['String']>;
  /** url text is optional */
  readonly urlText: Maybe<Scalars['String']>;
};

/** Connection between the LinkTreeItem type and the TermNode type */
type WpLinkTreeItemToTermNodeConnection = {
  /** The nodes of the connection, without the edges */
  readonly nodes: Maybe<ReadonlyArray<Maybe<WpTermNode>>>;
};
...
/** The Teaser type */
type WpTeaser = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpNodeWithFeaturedImage & WpNodeWithExcerpt & WpMenuItemLinkable & {
  /** Connection between the ContentNode type and the ContentType type */
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  readonly contentTypeName: Scalars['String'];
  ...
  /** The current status of the object */
  readonly status: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Teaser Informations&quot; was set to Show in GraphQL. */
  readonly teaserInformations: Maybe<WpTeaser_Teaserinformations>;
  /** The template assigned to a node of content */
  readonly template: Maybe<WpContentTemplate>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
...
/** Field Group */
type WpTeaser_Teaserinformations = WpAcfFieldGroup & {
  ...
  /** optional link page path */
  readonly pagePath: Maybe<Scalars['String']>;
  readonly post: Maybe<ReadonlyArray<Maybe<WpTeaser_Teaserinformations_Post>>>;
};

type WpTeaser_Teaserinformations_Post = WpNewsItem | WpEvent;
...
type WpContact = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpNodeWithRevisions & WpMenuItemLinkable & {
  /** Connection between the Contact type and the ContactCategory type */
  readonly contactCategories: Maybe<WpContactToContactCategoryConnection>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Contact Informations&quot; was set to Show in GraphQL. */
  readonly contactInformations: Maybe<WpContact_Contactinformations>;
  /** Connection between the ContentNode type and the ContentType type */
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  readonly contentTypeName: Scalars['String'];
  ...
  readonly template: Maybe<WpContentTemplate>;
  /** Connection between the Contact type and the TermNode type */
  readonly terms: Maybe<WpContactToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
  /** The unique resource identifier path */
  readonly uri: Maybe<Scalars['String']>;
...
type WpContact_modifiedGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type WpOrganization = Node & WpNode & WpContentNode & WpUniformResourceIdentifiable & WpDatabaseIdentifier & WpNodeWithTemplate & WpNodeWithTitle & WpMenuItemLinkable & {
  /** Connection between the ContentNode type and the ContentType type */
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  readonly contentTypeName: Scalars['String'];
  ...
  readonly modifiedGmt: Maybe<Scalars['Date']>;
  /** Connection between the Organization type and the OrganizationCategory type */
  readonly organizationCategories: Maybe<WpOrganizationToOrganizationCategoryConnection>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Organization Informations&quot; was set to Show in GraphQL. */
  readonly organizationInformations: Maybe<WpOrganization_Organizationinformations>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  readonly slug: Maybe<Scalars['String']>;
  /** The current status of the object */
  readonly status: Maybe<Scalars['String']>;
  ...
  readonly template: Maybe<WpContentTemplate>;
  /** Connection between the Organization type and the TermNode type */
  readonly terms: Maybe<WpOrganizationToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  readonly title: Maybe<Scalars['String']>;
  /** The unique resource identifier path */
  readonly uri: Maybe<Scalars['String']>;
...
type WpOrganization_dateGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type WpOrganization_modifiedArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type WpOrganization_modifiedGmtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type Query = {
  ...
  readonly wpEvent: Maybe<WpEvent>;
  readonly allWpEvent: WpEventConnection;
  readonly wpEventCategory: Maybe<WpEventCategory>;
  readonly allWpEventCategory: WpEventCategoryConnection;
  readonly wpContact: Maybe<WpContact>;
  readonly allWpContact: WpContactConnection;
  readonly wpContactCategory: Maybe<WpContactCategory>;
  readonly allWpContactCategory: WpContactCategoryConnection;
  readonly wpOrganization: Maybe<WpOrganization>;
  readonly allWpOrganization: WpOrganizationConnection;
  readonly wpOrganizationCategory: Maybe<WpOrganizationCategory>;
  readonly allWpOrganizationCategory: WpOrganizationCategoryConnection;
  readonly wpNewsItem: Maybe<WpNewsItem>;
  readonly allWpNewsItem: WpNewsItemConnection;
  readonly wpNewsCategory: Maybe<WpNewsCategory>;
  readonly allWpNewsCategory: WpNewsCategoryConnection;
  readonly wpUserRole: Maybe<WpUserRole>;
  readonly allWpUserRole: WpUserRoleConnection;
  readonly wpLinkTreeItem: Maybe<WpLinkTreeItem>;
  readonly allWpLinkTreeItem: WpLinkTreeItemConnection;
  readonly wpLinkTreeItemCategory: Maybe<WpLinkTreeItemCategory>;
  readonly allWpLinkTreeItemCategory: WpLinkTreeItemCategoryConnection;
  ...
  readonly wpTeaser: Maybe<WpTeaser>;
  readonly allWpTeaser: WpTeaserConnection;
...
type Query_wpTagArgs = {
  ...
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  events: Maybe<WpTagToEventConnectionFilterInput>;
  id: Maybe<StringQueryOperatorInput>;
  isContentNode: Maybe<BooleanQueryOperatorInput>;
  isTermNode: Maybe<BooleanQueryOperatorInput>;
  link: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
  newsItems: Maybe<WpTagToNewsItemConnectionFilterInput>;
...
type Query_wpEventArgs = {
  ...
  desiredSlug: Maybe<StringQueryOperatorInput>;
  enclosure: Maybe<StringQueryOperatorInput>;
  eventCategories: Maybe<WpEventToEventCategoryConnectionFilterInput>;
  eventInformations: Maybe<WpEvent_EventinformationsFilterInput>;
  excerpt: Maybe<StringQueryOperatorInput>;
  featuredImage: Maybe<WpNodeWithFeaturedImageToMediaItemConnectionEdgeFilterInput>;
  featuredImageDatabaseId: Maybe<IntQueryOperatorInput>;
  featuredImageId: Maybe<IDQueryOperatorInput>;
  ...
  slug: Maybe<StringQueryOperatorInput>;
  status: Maybe<StringQueryOperatorInput>;
  tags: Maybe<WpEventToTagConnectionFilterInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  terms: Maybe<WpEventToTermNodeConnectionFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
...
type Query_wpEventCategoryArgs = {
  ancestors: Maybe<WpEventCategoryToAncestorsEventCategoryConnectionFilterInput>;
  wpChildren: Maybe<WpEventCategoryToEventCategoryConnectionFilterInput>;
  contentNodes: Maybe<WpEventCategoryToContentNodeConnectionFilterInput>;
  count: Maybe<IntQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  events: Maybe<WpEventCategoryToEventConnectionFilterInput>;
  id: Maybe<StringQueryOperatorInput>;
  isContentNode: Maybe<BooleanQueryOperatorInput>;
  isTermNode: Maybe<BooleanQueryOperatorInput>;
  link: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
  wpParent: Maybe<WpEventCategoryToParentEventCategoryConnectionEdgeFilterInput>;
  parentDatabaseId: Maybe<IntQueryOperatorInput>;
  parentId: Maybe<IDQueryOperatorInput>;
  slug: Maybe<StringQueryOperatorInput>;
  taxonomy: Maybe<WpEventCategoryToTaxonomyConnectionEdgeFilterInput>;
  taxonomyName: Maybe<StringQueryOperatorInput>;
  termGroupId: Maybe<IntQueryOperatorInput>;
  termTaxonomyId: Maybe<IntQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
...
type Query_allWpEventCategoryArgs = {
  filter: Maybe<WpEventCategoryFilterInput>;
  sort: Maybe<WpEventCategorySortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpContactArgs = {
  contactCategories: Maybe<WpContactToContactCategoryConnectionFilterInput>;
  contactInformations: Maybe<WpContact_ContactinformationsFilterInput>;
  contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  contentTypeName: Maybe<StringQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  date: Maybe<DateQueryOperatorInput>;
  ...
  status: Maybe<StringQueryOperatorInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  terms: Maybe<WpContactToTermNodeConnectionFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
...
type Query_allWpContactArgs = {
  filter: Maybe<WpContactFilterInput>;
  sort: Maybe<WpContactSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpContactCategoryArgs = {
  contacts: Maybe<WpContactCategoryToContactConnectionFilterInput>;
  contentNodes: Maybe<WpContactCategoryToContentNodeConnectionFilterInput>;
  count: Maybe<IntQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  id: Maybe<StringQueryOperatorInput>;
  ...
  name: Maybe<StringQueryOperatorInput>;
  slug: Maybe<StringQueryOperatorInput>;
  taxonomy: Maybe<WpContactCategoryToTaxonomyConnectionEdgeFilterInput>;
  taxonomyName: Maybe<StringQueryOperatorInput>;
  termGroupId: Maybe<IntQueryOperatorInput>;
  termTaxonomyId: Maybe<IntQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
...
type Query_allWpContactCategoryArgs = {
  filter: Maybe<WpContactCategoryFilterInput>;
  sort: Maybe<WpContactCategorySortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpOrganizationArgs = {
  contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  contentTypeName: Maybe<StringQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  date: Maybe<DateQueryOperatorInput>;
  ...
  modified: Maybe<DateQueryOperatorInput>;
  modifiedGmt: Maybe<DateQueryOperatorInput>;
  organizationCategories: Maybe<WpOrganizationToOrganizationCategoryConnectionFilterInput>;
  organizationInformations: Maybe<WpOrganization_OrganizationinformationsFilterInput>;
  slug: Maybe<StringQueryOperatorInput>;
  status: Maybe<StringQueryOperatorInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  terms: Maybe<WpOrganizationToTermNodeConnectionFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
...
type Query_allWpOrganizationArgs = {
  filter: Maybe<WpOrganizationFilterInput>;
  sort: Maybe<WpOrganizationSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpOrganizationCategoryArgs = {
  contentNodes: Maybe<WpOrganizationCategoryToContentNodeConnectionFilterInput>;
  count: Maybe<IntQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  id: Maybe<StringQueryOperatorInput>;
  ...
  link: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
  organizations: Maybe<WpOrganizationCategoryToOrganizationConnectionFilterInput>;
  slug: Maybe<StringQueryOperatorInput>;
  taxonomy: Maybe<WpOrganizationCategoryToTaxonomyConnectionEdgeFilterInput>;
  taxonomyName: Maybe<StringQueryOperatorInput>;
  termGroupId: Maybe<IntQueryOperatorInput>;
  termTaxonomyId: Maybe<IntQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
...
type Query_allWpOrganizationCategoryArgs = {
  filter: Maybe<WpOrganizationCategoryFilterInput>;
  sort: Maybe<WpOrganizationCategorySortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpNewsItemArgs = {
  attachments: Maybe<WpAttachmentFilterListInput>;
  content: Maybe<StringQueryOperatorInput>;
  contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  contentTypeName: Maybe<StringQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  ...
  modified: Maybe<DateQueryOperatorInput>;
  modifiedGmt: Maybe<DateQueryOperatorInput>;
  newsCategories: Maybe<WpNewsItemToNewsCategoryConnectionFilterInput>;
  slug: Maybe<StringQueryOperatorInput>;
  status: Maybe<StringQueryOperatorInput>;
  tags: Maybe<WpNewsItemToTagConnectionFilterInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  terms: Maybe<WpNewsItemToTermNodeConnectionFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
...
type Query_allWpNewsItemArgs = {
  filter: Maybe<WpNewsItemFilterInput>;
  sort: Maybe<WpNewsItemSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpNewsCategoryArgs = {
  ancestors: Maybe<WpNewsCategoryToAncestorsNewsCategoryConnectionFilterInput>;
  wpChildren: Maybe<WpNewsCategoryToNewsCategoryConnectionFilterInput>;
  contentNodes: Maybe<WpNewsCategoryToContentNodeConnectionFilterInput>;
  count: Maybe<IntQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  id: Maybe<StringQueryOperatorInput>;
  ...
  link: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
  newsItems: Maybe<WpNewsCategoryToNewsItemConnectionFilterInput>;
  wpParent: Maybe<WpNewsCategoryToParentNewsCategoryConnectionEdgeFilterInput>;
  parentDatabaseId: Maybe<IntQueryOperatorInput>;
  parentId: Maybe<IDQueryOperatorInput>;
  slug: Maybe<StringQueryOperatorInput>;
  taxonomy: Maybe<WpNewsCategoryToTaxonomyConnectionEdgeFilterInput>;
  taxonomyName: Maybe<StringQueryOperatorInput>;
  termGroupId: Maybe<IntQueryOperatorInput>;
  termTaxonomyId: Maybe<IntQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
...
type Query_allWpNewsCategoryArgs = {
  filter: Maybe<WpNewsCategoryFilterInput>;
  sort: Maybe<WpNewsCategorySortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type Query_wpLinkTreeItemArgs = {
  ...
  lastEditedBy: Maybe<WpContentNodeToEditLastConnectionEdgeFilterInput>;
  link: Maybe<StringQueryOperatorInput>;
  linkTreeItemCategories: Maybe<WpLinkTreeItemToLinkTreeItemCategoryConnectionFilterInput>;
  linkTreeItemInformation: Maybe<WpLinkTreeItem_LinktreeiteminformationFilterInput>;
  modified: Maybe<DateQueryOperatorInput>;
  modifiedGmt: Maybe<DateQueryOperatorInput>;
  slug: Maybe<StringQueryOperatorInput>;
  status: Maybe<StringQueryOperatorInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  terms: Maybe<WpLinkTreeItemToTermNodeConnectionFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
...
type Query_allWpLinkTreeItemArgs = {
  filter: Maybe<WpLinkTreeItemFilterInput>;
  sort: Maybe<WpLinkTreeItemSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_wpLinkTreeItemCategoryArgs = {
  contentNodes: Maybe<WpLinkTreeItemCategoryToContentNodeConnectionFilterInput>;
  count: Maybe<IntQueryOperatorInput>;
  databaseId: Maybe<IntQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  id: Maybe<StringQueryOperatorInput>;
  ...
  isTermNode: Maybe<BooleanQueryOperatorInput>;
  link: Maybe<StringQueryOperatorInput>;
  linkTreeItems: Maybe<WpLinkTreeItemCategoryToLinkTreeItemConnectionFilterInput>;
  name: Maybe<StringQueryOperatorInput>;
  slug: Maybe<StringQueryOperatorInput>;
  taxonomy: Maybe<WpLinkTreeItemCategoryToTaxonomyConnectionEdgeFilterInput>;
  taxonomyName: Maybe<StringQueryOperatorInput>;
  termGroupId: Maybe<IntQueryOperatorInput>;
  termTaxonomyId: Maybe<IntQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
...
type Query_allWpLinkTreeItemCategoryArgs = {
  filter: Maybe<WpLinkTreeItemCategoryFilterInput>;
  sort: Maybe<WpLinkTreeItemCategorySortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type Query_wpTeaserArgs = {
  ...
  slug: Maybe<StringQueryOperatorInput>;
  status: Maybe<StringQueryOperatorInput>;
  teaserInformations: Maybe<WpTeaser_TeaserinformationsFilterInput>;
  template: Maybe<WpContentTemplateFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  uri: Maybe<StringQueryOperatorInput>;
  nodeType: Maybe<StringQueryOperatorInput>;
...
type Query_allWpTeaserArgs = {
  filter: Maybe<WpTeaserFilterInput>;
  sort: Maybe<WpTeaserSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type WpTagFilterInput = {
  ...
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly events: Maybe<WpTagToEventConnectionFilterInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly isContentNode: Maybe<BooleanQueryOperatorInput>;
  readonly isTermNode: Maybe<BooleanQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly newsItems: Maybe<WpTagToNewsItemConnectionFilterInput>;
...
type WpTagToEventConnectionFilterInput = {
  readonly nodes: Maybe<WpEventFilterListInput>;
};

type WpEventFilterListInput = {
  readonly elemMatch: Maybe<WpEventFilterInput>;
};

type WpEventFilterInput = {
  readonly ancestors: Maybe<WpHierarchicalContentNodeToContentNodeAncestorsConnectionFilterInput>;
  readonly wpChildren: Maybe<WpHierarchicalContentNodeToContentNodeChildrenConnectionFilterInput>;
  readonly content: Maybe<StringQueryOperatorInput>;
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  ...
  readonly desiredSlug: Maybe<StringQueryOperatorInput>;
  readonly enclosure: Maybe<StringQueryOperatorInput>;
  readonly eventCategories: Maybe<WpEventToEventCategoryConnectionFilterInput>;
  readonly eventInformations: Maybe<WpEvent_EventinformationsFilterInput>;
  readonly excerpt: Maybe<StringQueryOperatorInput>;
  readonly featuredImage: Maybe<WpNodeWithFeaturedImageToMediaItemConnectionEdgeFilterInput>;
  readonly featuredImageDatabaseId: Maybe<IntQueryOperatorInput>;
  readonly featuredImageId: Maybe<IDQueryOperatorInput>;
  ...
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly tags: Maybe<WpEventToTagConnectionFilterInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly terms: Maybe<WpEventToTermNodeConnectionFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
...
type WpEventToEventCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpEventCategoryFilterListInput>;
};

type WpEventCategoryFilterListInput = {
  readonly elemMatch: Maybe<WpEventCategoryFilterInput>;
};

type WpEventCategoryFilterInput = {
  readonly ancestors: Maybe<WpEventCategoryToAncestorsEventCategoryConnectionFilterInput>;
  readonly wpChildren: Maybe<WpEventCategoryToEventCategoryConnectionFilterInput>;
  readonly contentNodes: Maybe<WpEventCategoryToContentNodeConnectionFilterInput>;
  readonly count: Maybe<IntQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly events: Maybe<WpEventCategoryToEventConnectionFilterInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly isContentNode: Maybe<BooleanQueryOperatorInput>;
  readonly isTermNode: Maybe<BooleanQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly wpParent: Maybe<WpEventCategoryToParentEventCategoryConnectionEdgeFilterInput>;
  readonly parentDatabaseId: Maybe<IntQueryOperatorInput>;
  readonly parentId: Maybe<IDQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly taxonomy: Maybe<WpEventCategoryToTaxonomyConnectionEdgeFilterInput>;
  readonly taxonomyName: Maybe<StringQueryOperatorInput>;
  readonly termGroupId: Maybe<IntQueryOperatorInput>;
  readonly termTaxonomyId: Maybe<IntQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
...
type WpEventCategoryToAncestorsEventCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpEventCategoryFilterListInput>;
};

type WpEventCategoryToEventCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpEventCategoryFilterListInput>;
};

type WpEventCategoryToContentNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpContentNodeFilterListInput>;
};

type WpEventCategoryToEventConnectionFilterInput = {
  readonly nodes: Maybe<WpEventFilterListInput>;
};

type WpEventCategoryToParentEventCategoryConnectionEdgeFilterInput = {
  readonly node: Maybe<WpEventCategoryFilterInput>;
};

type WpEventCategoryToTaxonomyConnectionEdgeFilterInput = {
  readonly node: Maybe<WpTaxonomyFilterInput>;
};

type WpEvent_EventinformationsFilterInput = {
  readonly endDate: Maybe<StringQueryOperatorInput>;
  readonly endTime: Maybe<StringQueryOperatorInput>;
  readonly fieldGroupName: Maybe<StringQueryOperatorInput>;
  readonly startDate: Maybe<StringQueryOperatorInput>;
  readonly startTime: Maybe<StringQueryOperatorInput>;
};

type WpEventToTagConnectionFilterInput = {
  readonly nodes: Maybe<WpTagFilterListInput>;
};

type WpEventToTermNodeConnectionFilterInput = {
...
type WpTagToNewsItemConnectionFilterInput = {
  readonly nodes: Maybe<WpNewsItemFilterListInput>;
};

type WpNewsItemFilterListInput = {
  readonly elemMatch: Maybe<WpNewsItemFilterInput>;
};

type WpNewsItemFilterInput = {
  readonly attachments: Maybe<WpAttachmentFilterListInput>;
  readonly content: Maybe<StringQueryOperatorInput>;
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  readonly contentTypeName: Maybe<StringQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  ...
  readonly modified: Maybe<DateQueryOperatorInput>;
  readonly modifiedGmt: Maybe<DateQueryOperatorInput>;
  readonly newsCategories: Maybe<WpNewsItemToNewsCategoryConnectionFilterInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly tags: Maybe<WpNewsItemToTagConnectionFilterInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly terms: Maybe<WpNewsItemToTermNodeConnectionFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
...
type WpAttachmentFilterListInput = {
  readonly elemMatch: Maybe<WpAttachmentFilterInput>;
};

type WpAttachmentFilterInput = {
  readonly fileSizeHumanReadable: Maybe<StringQueryOperatorInput>;
  readonly filename: Maybe<StringQueryOperatorInput>;
  readonly icon: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<IntQueryOperatorInput>;
  readonly subtype: Maybe<StringQueryOperatorInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly url: Maybe<StringQueryOperatorInput>;
};

type WpNewsItemToNewsCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpNewsCategoryFilterListInput>;
};

type WpNewsCategoryFilterListInput = {
  readonly elemMatch: Maybe<WpNewsCategoryFilterInput>;
};

type WpNewsCategoryFilterInput = {
  readonly ancestors: Maybe<WpNewsCategoryToAncestorsNewsCategoryConnectionFilterInput>;
  readonly wpChildren: Maybe<WpNewsCategoryToNewsCategoryConnectionFilterInput>;
  readonly contentNodes: Maybe<WpNewsCategoryToContentNodeConnectionFilterInput>;
  readonly count: Maybe<IntQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  ...
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly newsItems: Maybe<WpNewsCategoryToNewsItemConnectionFilterInput>;
  readonly wpParent: Maybe<WpNewsCategoryToParentNewsCategoryConnectionEdgeFilterInput>;
  readonly parentDatabaseId: Maybe<IntQueryOperatorInput>;
  readonly parentId: Maybe<IDQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly taxonomy: Maybe<WpNewsCategoryToTaxonomyConnectionEdgeFilterInput>;
  readonly taxonomyName: Maybe<StringQueryOperatorInput>;
  readonly termGroupId: Maybe<IntQueryOperatorInput>;
  readonly termTaxonomyId: Maybe<IntQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
...
type WpNewsCategoryToAncestorsNewsCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpNewsCategoryFilterListInput>;
};

type WpNewsCategoryToNewsCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpNewsCategoryFilterListInput>;
};

type WpNewsCategoryToContentNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpContentNodeFilterListInput>;
};

type WpNewsCategoryToNewsItemConnectionFilterInput = {
  readonly nodes: Maybe<WpNewsItemFilterListInput>;
};

type WpNewsCategoryToParentNewsCategoryConnectionEdgeFilterInput = {
  readonly node: Maybe<WpNewsCategoryFilterInput>;
};

type WpNewsCategoryToTaxonomyConnectionEdgeFilterInput = {
  readonly node: Maybe<WpTaxonomyFilterInput>;
};

type WpNewsItemToTagConnectionFilterInput = {
  readonly nodes: Maybe<WpTagFilterListInput>;
};

type WpNewsItemToTermNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpTermNodeFilterListInput>;
};
...
type WpPostFieldsEnum =
  ...
  | 'tags.nodes.events.nodes'
  | 'tags.nodes.id'
  | 'tags.nodes.isContentNode'
  | 'tags.nodes.isTermNode'
  | 'tags.nodes.link'
  | 'tags.nodes.name'
  | 'tags.nodes.newsItems.nodes'
...
type WpTagFieldsEnum =
  ...
  | 'description'
  | 'events.nodes'
  | 'events.nodes.ancestors.nodes'
  | 'events.nodes.wpChildren.nodes'
  | 'events.nodes.content'
  | 'events.nodes.contentTypeName'
  | 'events.nodes.databaseId'
  | 'events.nodes.date'
  | 'events.nodes.dateGmt'
  | 'events.nodes.desiredSlug'
  | 'events.nodes.enclosure'
  | 'events.nodes.eventCategories.nodes'
  | 'events.nodes.eventInformations.endDate'
  | 'events.nodes.eventInformations.endTime'
  | 'events.nodes.eventInformations.fieldGroupName'
  | 'events.nodes.eventInformations.startDate'
  | 'events.nodes.eventInformations.startTime'
  | 'events.nodes.excerpt'
  | 'events.nodes.featuredImageDatabaseId'
  | 'events.nodes.featuredImageId'
  | 'events.nodes.guid'
  | 'events.nodes.id'
  | 'events.nodes.isContentNode'
  | 'events.nodes.isTermNode'
  | 'events.nodes.link'
  | 'events.nodes.menuOrder'
  | 'events.nodes.modified'
  | 'events.nodes.modifiedGmt'
  | 'events.nodes.parentDatabaseId'
  | 'events.nodes.parentId'
  | 'events.nodes.slug'
  | 'events.nodes.status'
  | 'events.nodes.tags.nodes'
  | 'events.nodes.template.templateName'
  | 'events.nodes.terms.nodes'
  | 'events.nodes.title'
  | 'events.nodes.uri'
  | 'events.nodes.nodeType'
  | 'events.nodes.parent.id'
  | 'events.nodes.parent.children'
  | 'events.nodes.children'
  | 'events.nodes.children.id'
  | 'events.nodes.children.children'
  | 'events.nodes.internal.content'
  | 'events.nodes.internal.contentDigest'
  | 'events.nodes.internal.description'
  | 'events.nodes.internal.fieldOwners'
  | 'events.nodes.internal.ignoreType'
  | 'events.nodes.internal.mediaType'
  | 'events.nodes.internal.owner'
  | 'events.nodes.internal.type'
  | 'id'
  | 'isContentNode'
  | 'isTermNode'
  | 'link'
  | 'name'
  | 'newsItems.nodes'
  | 'newsItems.nodes.attachments'
  | 'newsItems.nodes.attachments.fileSizeHumanReadable'
  | 'newsItems.nodes.attachments.filename'
  | 'newsItems.nodes.attachments.icon'
  | 'newsItems.nodes.attachments.id'
  | 'newsItems.nodes.attachments.subtype'
  | 'newsItems.nodes.attachments.title'
  | 'newsItems.nodes.attachments.url'
  | 'newsItems.nodes.content'
  | 'newsItems.nodes.contentTypeName'
  | 'newsItems.nodes.databaseId'
  | 'newsItems.nodes.date'
  | 'newsItems.nodes.dateGmt'
  | 'newsItems.nodes.desiredSlug'
  | 'newsItems.nodes.enclosure'
  | 'newsItems.nodes.excerpt'
  | 'newsItems.nodes.featuredImageDatabaseId'
  | 'newsItems.nodes.featuredImageId'
  | 'newsItems.nodes.guid'
  | 'newsItems.nodes.id'
  | 'newsItems.nodes.isContentNode'
  | 'newsItems.nodes.isTermNode'
  | 'newsItems.nodes.link'
  | 'newsItems.nodes.modified'
  | 'newsItems.nodes.modifiedGmt'
  | 'newsItems.nodes.newsCategories.nodes'
  | 'newsItems.nodes.slug'
  | 'newsItems.nodes.status'
  | 'newsItems.nodes.tags.nodes'
  | 'newsItems.nodes.template.templateName'
  | 'newsItems.nodes.terms.nodes'
  | 'newsItems.nodes.title'
  | 'newsItems.nodes.uri'
  | 'newsItems.nodes.nodeType'
  | 'newsItems.nodes.parent.id'
  | 'newsItems.nodes.parent.children'
  | 'newsItems.nodes.children'
  | 'newsItems.nodes.children.id'
  | 'newsItems.nodes.children.children'
  | 'newsItems.nodes.internal.content'
  | 'newsItems.nodes.internal.contentDigest'
  | 'newsItems.nodes.internal.description'
  | 'newsItems.nodes.internal.fieldOwners'
  | 'newsItems.nodes.internal.ignoreType'
  | 'newsItems.nodes.internal.mediaType'
  | 'newsItems.nodes.internal.owner'
  | 'newsItems.nodes.internal.type'
  | 'posts.nodes'
  | 'posts.nodes.authorDatabaseId'
  | 'posts.nodes.authorId'
  | 'posts.nodes.categories.nodes'
...
type WpEventConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpEventEdge>;
  readonly nodes: ReadonlyArray<WpEvent>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpEventGroupConnection>;
};


type WpEventConnection_distinctArgs = {
  field: WpEventFieldsEnum;
};


type WpEventConnection_maxArgs = {
  field: WpEventFieldsEnum;
};


type WpEventConnection_minArgs = {
  field: WpEventFieldsEnum;
};


type WpEventConnection_sumArgs = {
  field: WpEventFieldsEnum;
};


type WpEventConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpEventFieldsEnum;
};
...
type WpEventEdge = {
  readonly next: Maybe<WpEvent>;
  readonly node: WpEvent;
  readonly previous: Maybe<WpEvent>;
};

type WpEventFieldsEnum =
  | 'ancestors.nodes'
  | 'ancestors.nodes.contentTypeName'
  | 'ancestors.nodes.databaseId'
  | 'ancestors.nodes.date'
  ...
  | 'desiredSlug'
  | 'enclosure'
  | 'eventCategories.nodes'
  | 'eventCategories.nodes.ancestors.nodes'
  | 'eventCategories.nodes.wpChildren.nodes'
  | 'eventCategories.nodes.contentNodes.nodes'
  | 'eventCategories.nodes.count'
  | 'eventCategories.nodes.databaseId'
  | 'eventCategories.nodes.description'
  | 'eventCategories.nodes.events.nodes'
  | 'eventCategories.nodes.id'
  | 'eventCategories.nodes.isContentNode'
  | 'eventCategories.nodes.isTermNode'
  | 'eventCategories.nodes.link'
  | 'eventCategories.nodes.name'
  | 'eventCategories.nodes.parentDatabaseId'
  | 'eventCategories.nodes.parentId'
  | 'eventCategories.nodes.slug'
  | 'eventCategories.nodes.taxonomyName'
  | 'eventCategories.nodes.termGroupId'
  | 'eventCategories.nodes.termTaxonomyId'
  | 'eventCategories.nodes.uri'
  | 'eventCategories.nodes.nodeType'
  | 'eventCategories.nodes.parent.id'
  | 'eventCategories.nodes.parent.children'
  | 'eventCategories.nodes.children'
  | 'eventCategories.nodes.children.id'
  | 'eventCategories.nodes.children.children'
  | 'eventCategories.nodes.internal.content'
  | 'eventCategories.nodes.internal.contentDigest'
  | 'eventCategories.nodes.internal.description'
  | 'eventCategories.nodes.internal.fieldOwners'
  | 'eventCategories.nodes.internal.ignoreType'
  | 'eventCategories.nodes.internal.mediaType'
  | 'eventCategories.nodes.internal.owner'
  | 'eventCategories.nodes.internal.type'
  | 'eventInformations.endDate'
  | 'eventInformations.endTime'
  | 'eventInformations.fieldGroupName'
  | 'eventInformations.startDate'
  | 'eventInformations.startTime'
  | 'excerpt'
  | 'featuredImage.node.altText'
  | 'featuredImage.node.ancestors.nodes'
  | 'featuredImage.node.authorDatabaseId'
...
type WpEventGroupConnection_distinctArgs = {
  field: WpEventFieldsEnum;
};


type WpEventGroupConnection_maxArgs = {
  field: WpEventFieldsEnum;
};


type WpEventGroupConnection_minArgs = {
  field: WpEventFieldsEnum;
};


type WpEventGroupConnection_sumArgs = {
  field: WpEventFieldsEnum;
};


type WpEventGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpEventFieldsEnum;
};

type WpEventSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpEventFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpEventCategoryConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpEventCategoryEdge>;
  readonly nodes: ReadonlyArray<WpEventCategory>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpEventCategoryGroupConnection>;
};


type WpEventCategoryConnection_distinctArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryConnection_maxArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryConnection_minArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryConnection_sumArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpEventCategoryFieldsEnum;
};

type WpEventCategoryEdge = {
  readonly next: Maybe<WpEventCategory>;
  readonly node: WpEventCategory;
  readonly previous: Maybe<WpEventCategory>;
};

type WpEventCategoryFieldsEnum =
  | 'ancestors.nodes'
  | 'ancestors.nodes.ancestors.nodes'
  | 'ancestors.nodes.wpChildren.nodes'
  | 'ancestors.nodes.contentNodes.nodes'
...
type WpEventCategoryGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpEventCategoryEdge>;
  readonly nodes: ReadonlyArray<WpEventCategory>;
  readonly pageInfo: PageInfo;
...
type WpEventCategoryGroupConnection_distinctArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryGroupConnection_maxArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryGroupConnection_minArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryGroupConnection_sumArgs = {
  field: WpEventCategoryFieldsEnum;
};


type WpEventCategoryGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpEventCategoryFieldsEnum;
};

type WpEventCategorySortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpEventCategoryFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpContactToContactCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpContactCategoryFilterListInput>;
};

type WpContactCategoryFilterListInput = {
  readonly elemMatch: Maybe<WpContactCategoryFilterInput>;
};

type WpContactCategoryFilterInput = {
  readonly contacts: Maybe<WpContactCategoryToContactConnectionFilterInput>;
  readonly contentNodes: Maybe<WpContactCategoryToContentNodeConnectionFilterInput>;
  readonly count: Maybe<IntQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  ...
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly taxonomy: Maybe<WpContactCategoryToTaxonomyConnectionEdgeFilterInput>;
  readonly taxonomyName: Maybe<StringQueryOperatorInput>;
  readonly termGroupId: Maybe<IntQueryOperatorInput>;
  readonly termTaxonomyId: Maybe<IntQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
...
type WpContactCategoryToContactConnectionFilterInput = {
  readonly nodes: Maybe<WpContactFilterListInput>;
};

type WpContactFilterListInput = {
  readonly elemMatch: Maybe<WpContactFilterInput>;
};

type WpContactFilterInput = {
  readonly contactCategories: Maybe<WpContactToContactCategoryConnectionFilterInput>;
  readonly contactInformations: Maybe<WpContact_ContactinformationsFilterInput>;
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  readonly contentTypeName: Maybe<StringQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly date: Maybe<DateQueryOperatorInput>;
  ...
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly terms: Maybe<WpContactToTermNodeConnectionFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
...
type WpContact_ContactinformationsFilterInput = {
  readonly email: Maybe<StringQueryOperatorInput>;
  readonly fieldGroupName: Maybe<StringQueryOperatorInput>;
  readonly firstName: Maybe<StringQueryOperatorInput>;
  readonly lastName: Maybe<StringQueryOperatorInput>;
  readonly phone: Maybe<StringQueryOperatorInput>;
  readonly photo: Maybe<WpMediaItemFilterInput>;
  readonly position: Maybe<StringQueryOperatorInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
};

type WpContactToTermNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpTermNodeFilterListInput>;
};

type WpContactCategoryToContentNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpContentNodeFilterListInput>;
};

type WpContactCategoryToTaxonomyConnectionEdgeFilterInput = {
  readonly node: Maybe<WpTaxonomyFilterInput>;
};

type WpContactConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpContactEdge>;
  readonly nodes: ReadonlyArray<WpContact>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpContactGroupConnection>;
};


type WpContactConnection_distinctArgs = {
  field: WpContactFieldsEnum;
};


type WpContactConnection_maxArgs = {
  field: WpContactFieldsEnum;
};


type WpContactConnection_minArgs = {
  field: WpContactFieldsEnum;
};


type WpContactConnection_sumArgs = {
  field: WpContactFieldsEnum;
};


type WpContactConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpContactFieldsEnum;
};
...
type WpContactEdge = {
  readonly next: Maybe<WpContact>;
  readonly node: WpContact;
  readonly previous: Maybe<WpContact>;
};

type WpContactFieldsEnum =
  | 'contactCategories.nodes'
  | 'contactCategories.nodes.contacts.nodes'
  | 'contactCategories.nodes.contentNodes.nodes'
  | 'contactCategories.nodes.count'
  | 'contactCategories.nodes.databaseId'
  | 'contactCategories.nodes.description'
  | 'contactCategories.nodes.id'
  | 'contactCategories.nodes.isContentNode'
  | 'contactCategories.nodes.isTermNode'
  | 'contactCategories.nodes.link'
  | 'contactCategories.nodes.name'
  | 'contactCategories.nodes.slug'
  | 'contactCategories.nodes.taxonomyName'
  | 'contactCategories.nodes.termGroupId'
  | 'contactCategories.nodes.termTaxonomyId'
  | 'contactCategories.nodes.uri'
  | 'contactCategories.nodes.nodeType'
  | 'contactCategories.nodes.parent.id'
  | 'contactCategories.nodes.parent.children'
  | 'contactCategories.nodes.children'
  | 'contactCategories.nodes.children.id'
  | 'contactCategories.nodes.children.children'
  | 'contactCategories.nodes.internal.content'
  | 'contactCategories.nodes.internal.contentDigest'
  | 'contactCategories.nodes.internal.description'
  | 'contactCategories.nodes.internal.fieldOwners'
  | 'contactCategories.nodes.internal.ignoreType'
  | 'contactCategories.nodes.internal.mediaType'
  | 'contactCategories.nodes.internal.owner'
  | 'contactCategories.nodes.internal.type'
  | 'contactInformations.email'
  | 'contactInformations.fieldGroupName'
  | 'contactInformations.firstName'
  | 'contactInformations.lastName'
  | 'contactInformations.phone'
  | 'contactInformations.photo.altText'
  | 'contactInformations.photo.ancestors.nodes'
  | 'contactInformations.photo.authorDatabaseId'
  | 'contactInformations.photo.authorId'
  | 'contactInformations.photo.caption'
  | 'contactInformations.photo.wpChildren.nodes'
  | 'contactInformations.photo.commentCount'
  | 'contactInformations.photo.commentStatus'
  | 'contactInformations.photo.comments.nodes'
  | 'contactInformations.photo.contentTypeName'
  | 'contactInformations.photo.databaseId'
  | 'contactInformations.photo.date'
  | 'contactInformations.photo.dateGmt'
  | 'contactInformations.photo.description'
  | 'contactInformations.photo.desiredSlug'
  | 'contactInformations.photo.enclosure'
  | 'contactInformations.photo.fileSize'
  | 'contactInformations.photo.guid'
  | 'contactInformations.photo.id'
  | 'contactInformations.photo.isContentNode'
  | 'contactInformations.photo.isTermNode'
  | 'contactInformations.photo.link'
  | 'contactInformations.photo.mediaDetails.file'
  | 'contactInformations.photo.mediaDetails.height'
  | 'contactInformations.photo.mediaDetails.sizes'
  | 'contactInformations.photo.mediaDetails.width'
  | 'contactInformations.photo.mediaItemUrl'
  | 'contactInformations.photo.mediaType'
  | 'contactInformations.photo.mimeType'
  | 'contactInformations.photo.modified'
  | 'contactInformations.photo.modifiedGmt'
  | 'contactInformations.photo.parentDatabaseId'
  | 'contactInformations.photo.parentId'
  | 'contactInformations.photo.sizes'
  | 'contactInformations.photo.slug'
  | 'contactInformations.photo.sourceUrl'
  | 'contactInformations.photo.srcSet'
  | 'contactInformations.photo.status'
  | 'contactInformations.photo.template.templateName'
  | 'contactInformations.photo.title'
  | 'contactInformations.photo.uri'
  | 'contactInformations.photo.nodeType'
  | 'contactInformations.photo.remoteFile.sourceInstanceName'
  | 'contactInformations.photo.remoteFile.absolutePath'
  | 'contactInformations.photo.remoteFile.relativePath'
  | 'contactInformations.photo.remoteFile.extension'
  | 'contactInformations.photo.remoteFile.size'
  | 'contactInformations.photo.remoteFile.prettySize'
  | 'contactInformations.photo.remoteFile.modifiedTime'
  | 'contactInformations.photo.remoteFile.accessTime'
  | 'contactInformations.photo.remoteFile.changeTime'
  | 'contactInformations.photo.remoteFile.birthTime'
  | 'contactInformations.photo.remoteFile.root'
  | 'contactInformations.photo.remoteFile.dir'
  | 'contactInformations.photo.remoteFile.base'
  | 'contactInformations.photo.remoteFile.ext'
  | 'contactInformations.photo.remoteFile.name'
  | 'contactInformations.photo.remoteFile.relativeDirectory'
  | 'contactInformations.photo.remoteFile.dev'
  | 'contactInformations.photo.remoteFile.mode'
  | 'contactInformations.photo.remoteFile.nlink'
  | 'contactInformations.photo.remoteFile.uid'
  | 'contactInformations.photo.remoteFile.gid'
  | 'contactInformations.photo.remoteFile.rdev'
  | 'contactInformations.photo.remoteFile.ino'
  | 'contactInformations.photo.remoteFile.atimeMs'
  | 'contactInformations.photo.remoteFile.mtimeMs'
  | 'contactInformations.photo.remoteFile.ctimeMs'
  | 'contactInformations.photo.remoteFile.atime'
  | 'contactInformations.photo.remoteFile.mtime'
  | 'contactInformations.photo.remoteFile.ctime'
  | 'contactInformations.photo.remoteFile.birthtime'
  | 'contactInformations.photo.remoteFile.birthtimeMs'
  | 'contactInformations.photo.remoteFile.blksize'
  | 'contactInformations.photo.remoteFile.blocks'
  | 'contactInformations.photo.remoteFile.url'
  | 'contactInformations.photo.remoteFile.publicURL'
  | 'contactInformations.photo.remoteFile.childrenImageSharp'
  | 'contactInformations.photo.remoteFile.id'
  | 'contactInformations.photo.remoteFile.children'
  | 'contactInformations.photo.localFile.sourceInstanceName'
  | 'contactInformations.photo.localFile.absolutePath'
  | 'contactInformations.photo.localFile.relativePath'
  | 'contactInformations.photo.localFile.extension'
  | 'contactInformations.photo.localFile.size'
  | 'contactInformations.photo.localFile.prettySize'
  | 'contactInformations.photo.localFile.modifiedTime'
  | 'contactInformations.photo.localFile.accessTime'
  | 'contactInformations.photo.localFile.changeTime'
  | 'contactInformations.photo.localFile.birthTime'
  | 'contactInformations.photo.localFile.root'
  | 'contactInformations.photo.localFile.dir'
  | 'contactInformations.photo.localFile.base'
  | 'contactInformations.photo.localFile.ext'
  | 'contactInformations.photo.localFile.name'
  | 'contactInformations.photo.localFile.relativeDirectory'
  | 'contactInformations.photo.localFile.dev'
  | 'contactInformations.photo.localFile.mode'
  | 'contactInformations.photo.localFile.nlink'
  | 'contactInformations.photo.localFile.uid'
  | 'contactInformations.photo.localFile.gid'
  | 'contactInformations.photo.localFile.rdev'
  | 'contactInformations.photo.localFile.ino'
  | 'contactInformations.photo.localFile.atimeMs'
  | 'contactInformations.photo.localFile.mtimeMs'
  | 'contactInformations.photo.localFile.ctimeMs'
  | 'contactInformations.photo.localFile.atime'
  | 'contactInformations.photo.localFile.mtime'
  | 'contactInformations.photo.localFile.ctime'
  | 'contactInformations.photo.localFile.birthtime'
  | 'contactInformations.photo.localFile.birthtimeMs'
  | 'contactInformations.photo.localFile.blksize'
  | 'contactInformations.photo.localFile.blocks'
  | 'contactInformations.photo.localFile.url'
  | 'contactInformations.photo.localFile.publicURL'
  | 'contactInformations.photo.localFile.childrenImageSharp'
  | 'contactInformations.photo.localFile.id'
  | 'contactInformations.photo.localFile.children'
  | 'contactInformations.photo.parent.id'
  | 'contactInformations.photo.parent.children'
  | 'contactInformations.photo.children'
  | 'contactInformations.photo.children.id'
  | 'contactInformations.photo.children.children'
  | 'contactInformations.photo.internal.content'
  | 'contactInformations.photo.internal.contentDigest'
  | 'contactInformations.photo.internal.description'
  | 'contactInformations.photo.internal.fieldOwners'
  | 'contactInformations.photo.internal.ignoreType'
  | 'contactInformations.photo.internal.mediaType'
  | 'contactInformations.photo.internal.owner'
  | 'contactInformations.photo.internal.type'
  | 'contactInformations.position'
...
type WpContactGroupConnection_distinctArgs = {
  field: WpContactFieldsEnum;
};


type WpContactGroupConnection_maxArgs = {
  field: WpContactFieldsEnum;
};


type WpContactGroupConnection_minArgs = {
  field: WpContactFieldsEnum;
};


type WpContactGroupConnection_sumArgs = {
  field: WpContactFieldsEnum;
};


type WpContactGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpContactFieldsEnum;
};

type WpContactSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpContactFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpContactCategoryConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpContactCategoryEdge>;
  readonly nodes: ReadonlyArray<WpContactCategory>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpContactCategoryGroupConnection>;
};


type WpContactCategoryConnection_distinctArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryConnection_maxArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryConnection_minArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryConnection_sumArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpContactCategoryFieldsEnum;
};

type WpContactCategoryEdge = {
  readonly next: Maybe<WpContactCategory>;
  readonly node: WpContactCategory;
  readonly previous: Maybe<WpContactCategory>;
};

type WpContactCategoryFieldsEnum =
  | 'contacts.nodes'
  | 'contacts.nodes.contactCategories.nodes'
  | 'contacts.nodes.contactInformations.email'
  | 'contacts.nodes.contactInformations.fieldGroupName'
  | 'contacts.nodes.contactInformations.firstName'
  | 'contacts.nodes.contactInformations.lastName'
  | 'contacts.nodes.contactInformations.phone'
  | 'contacts.nodes.contactInformations.position'
  | 'contacts.nodes.contactInformations.title'
  | 'contacts.nodes.contentTypeName'
  | 'contacts.nodes.databaseId'
  | 'contacts.nodes.date'
  | 'contacts.nodes.dateGmt'
  | 'contacts.nodes.desiredSlug'
  | 'contacts.nodes.enclosure'
  | 'contacts.nodes.guid'
  | 'contacts.nodes.id'
  | 'contacts.nodes.isContentNode'
  | 'contacts.nodes.isRevision'
  | 'contacts.nodes.isTermNode'
  | 'contacts.nodes.link'
  | 'contacts.nodes.modified'
  | 'contacts.nodes.modifiedGmt'
  | 'contacts.nodes.slug'
  | 'contacts.nodes.status'
  | 'contacts.nodes.template.templateName'
  | 'contacts.nodes.terms.nodes'
  | 'contacts.nodes.title'
  | 'contacts.nodes.uri'
  | 'contacts.nodes.nodeType'
  | 'contacts.nodes.parent.id'
  | 'contacts.nodes.parent.children'
  | 'contacts.nodes.children'
  | 'contacts.nodes.children.id'
  | 'contacts.nodes.children.children'
  | 'contacts.nodes.internal.content'
  | 'contacts.nodes.internal.contentDigest'
  | 'contacts.nodes.internal.description'
  | 'contacts.nodes.internal.fieldOwners'
  | 'contacts.nodes.internal.ignoreType'
  | 'contacts.nodes.internal.mediaType'
  | 'contacts.nodes.internal.owner'
  | 'contacts.nodes.internal.type'
  | 'contentNodes.nodes'
  | 'contentNodes.nodes.contentTypeName'
  | 'contentNodes.nodes.databaseId'
  | 'contentNodes.nodes.date'
...
type WpContactCategoryGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpContactCategoryEdge>;
  readonly nodes: ReadonlyArray<WpContactCategory>;
  readonly pageInfo: PageInfo;
...
type WpContactCategoryGroupConnection_distinctArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryGroupConnection_maxArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryGroupConnection_minArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryGroupConnection_sumArgs = {
  field: WpContactCategoryFieldsEnum;
};


type WpContactCategoryGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpContactCategoryFieldsEnum;
};

type WpContactCategorySortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpContactCategoryFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpOrganizationToOrganizationCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpOrganizationCategoryFilterListInput>;
};

type WpOrganizationCategoryFilterListInput = {
  readonly elemMatch: Maybe<WpOrganizationCategoryFilterInput>;
};

type WpOrganizationCategoryFilterInput = {
  readonly contentNodes: Maybe<WpOrganizationCategoryToContentNodeConnectionFilterInput>;
  readonly count: Maybe<IntQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  ...
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly organizations: Maybe<WpOrganizationCategoryToOrganizationConnectionFilterInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly taxonomy: Maybe<WpOrganizationCategoryToTaxonomyConnectionEdgeFilterInput>;
  readonly taxonomyName: Maybe<StringQueryOperatorInput>;
  readonly termGroupId: Maybe<IntQueryOperatorInput>;
  readonly termTaxonomyId: Maybe<IntQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
...
type WpOrganizationCategoryToContentNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpContentNodeFilterListInput>;
};

type WpOrganizationCategoryToOrganizationConnectionFilterInput = {
  readonly nodes: Maybe<WpOrganizationFilterListInput>;
};

type WpOrganizationFilterListInput = {
  readonly elemMatch: Maybe<WpOrganizationFilterInput>;
};

type WpOrganizationFilterInput = {
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  readonly contentTypeName: Maybe<StringQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly date: Maybe<DateQueryOperatorInput>;
  ...
  readonly modified: Maybe<DateQueryOperatorInput>;
  readonly modifiedGmt: Maybe<DateQueryOperatorInput>;
  readonly organizationCategories: Maybe<WpOrganizationToOrganizationCategoryConnectionFilterInput>;
  readonly organizationInformations: Maybe<WpOrganization_OrganizationinformationsFilterInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly terms: Maybe<WpOrganizationToTermNodeConnectionFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
...
type WpOrganization_OrganizationinformationsFilterInput = {
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly fieldGroupName: Maybe<StringQueryOperatorInput>;
...
type WpOrganizationToTermNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpTermNodeFilterListInput>;
};

type WpOrganizationCategoryToTaxonomyConnectionEdgeFilterInput = {
  readonly node: Maybe<WpTaxonomyFilterInput>;
};

type WpOrganizationConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpOrganizationEdge>;
  readonly nodes: ReadonlyArray<WpOrganization>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpOrganizationGroupConnection>;
};


type WpOrganizationConnection_distinctArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationConnection_maxArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationConnection_minArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationConnection_sumArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpOrganizationFieldsEnum;
};

type WpOrganizationEdge = {
  readonly next: Maybe<WpOrganization>;
  readonly node: WpOrganization;
  readonly previous: Maybe<WpOrganization>;
};

type WpOrganizationFieldsEnum =
  | 'contentType.node.archivePath'
  | 'contentType.node.canExport'
  | 'contentType.node.connectedTaxonomies.nodes'
  | 'contentType.node.contentNodes.nodes'
  ...
  | 'modified'
  | 'modifiedGmt'
  | 'organizationCategories.nodes'
  | 'organizationCategories.nodes.contentNodes.nodes'
  | 'organizationCategories.nodes.count'
  | 'organizationCategories.nodes.databaseId'
  | 'organizationCategories.nodes.description'
  | 'organizationCategories.nodes.id'
  | 'organizationCategories.nodes.isContentNode'
  | 'organizationCategories.nodes.isTermNode'
  | 'organizationCategories.nodes.link'
  | 'organizationCategories.nodes.name'
  | 'organizationCategories.nodes.organizations.nodes'
  | 'organizationCategories.nodes.slug'
  | 'organizationCategories.nodes.taxonomyName'
  | 'organizationCategories.nodes.termGroupId'
  | 'organizationCategories.nodes.termTaxonomyId'
  | 'organizationCategories.nodes.uri'
  | 'organizationCategories.nodes.nodeType'
  | 'organizationCategories.nodes.parent.id'
  | 'organizationCategories.nodes.parent.children'
  | 'organizationCategories.nodes.children'
  | 'organizationCategories.nodes.children.id'
  | 'organizationCategories.nodes.children.children'
  | 'organizationCategories.nodes.internal.content'
  | 'organizationCategories.nodes.internal.contentDigest'
  | 'organizationCategories.nodes.internal.description'
  | 'organizationCategories.nodes.internal.fieldOwners'
  | 'organizationCategories.nodes.internal.ignoreType'
  | 'organizationCategories.nodes.internal.mediaType'
  | 'organizationCategories.nodes.internal.owner'
  | 'organizationCategories.nodes.internal.type'
  | 'organizationInformations.description'
  | 'organizationInformations.fieldGroupName'
  | 'organizationInformations.logo.altText'
  | 'organizationInformations.logo.ancestors.nodes'
  | 'organizationInformations.logo.authorDatabaseId'
  | 'organizationInformations.logo.authorId'
  | 'organizationInformations.logo.caption'
  | 'organizationInformations.logo.wpChildren.nodes'
  | 'organizationInformations.logo.commentCount'
  | 'organizationInformations.logo.commentStatus'
  | 'organizationInformations.logo.comments.nodes'
  | 'organizationInformations.logo.contentTypeName'
  | 'organizationInformations.logo.databaseId'
  | 'organizationInformations.logo.date'
  | 'organizationInformations.logo.dateGmt'
  | 'organizationInformations.logo.description'
  | 'organizationInformations.logo.desiredSlug'
  | 'organizationInformations.logo.enclosure'
  | 'organizationInformations.logo.fileSize'
  | 'organizationInformations.logo.guid'
  | 'organizationInformations.logo.id'
  | 'organizationInformations.logo.isContentNode'
  | 'organizationInformations.logo.isTermNode'
  | 'organizationInformations.logo.link'
  | 'organizationInformations.logo.mediaDetails.file'
  | 'organizationInformations.logo.mediaDetails.height'
  | 'organizationInformations.logo.mediaDetails.sizes'
  | 'organizationInformations.logo.mediaDetails.width'
  | 'organizationInformations.logo.mediaItemUrl'
  | 'organizationInformations.logo.mediaType'
  | 'organizationInformations.logo.mimeType'
  | 'organizationInformations.logo.modified'
  | 'organizationInformations.logo.modifiedGmt'
  | 'organizationInformations.logo.parentDatabaseId'
  | 'organizationInformations.logo.parentId'
  | 'organizationInformations.logo.sizes'
  | 'organizationInformations.logo.slug'
  | 'organizationInformations.logo.sourceUrl'
  | 'organizationInformations.logo.srcSet'
  | 'organizationInformations.logo.status'
  | 'organizationInformations.logo.template.templateName'
  | 'organizationInformations.logo.title'
  | 'organizationInformations.logo.uri'
  | 'organizationInformations.logo.nodeType'
  | 'organizationInformations.logo.remoteFile.sourceInstanceName'
  | 'organizationInformations.logo.remoteFile.absolutePath'
  | 'organizationInformations.logo.remoteFile.relativePath'
  | 'organizationInformations.logo.remoteFile.extension'
  | 'organizationInformations.logo.remoteFile.size'
  | 'organizationInformations.logo.remoteFile.prettySize'
  | 'organizationInformations.logo.remoteFile.modifiedTime'
  | 'organizationInformations.logo.remoteFile.accessTime'
  | 'organizationInformations.logo.remoteFile.changeTime'
  | 'organizationInformations.logo.remoteFile.birthTime'
  | 'organizationInformations.logo.remoteFile.root'
  | 'organizationInformations.logo.remoteFile.dir'
  | 'organizationInformations.logo.remoteFile.base'
  | 'organizationInformations.logo.remoteFile.ext'
  | 'organizationInformations.logo.remoteFile.name'
  | 'organizationInformations.logo.remoteFile.relativeDirectory'
  | 'organizationInformations.logo.remoteFile.dev'
  | 'organizationInformations.logo.remoteFile.mode'
  | 'organizationInformations.logo.remoteFile.nlink'
  | 'organizationInformations.logo.remoteFile.uid'
  | 'organizationInformations.logo.remoteFile.gid'
  | 'organizationInformations.logo.remoteFile.rdev'
  | 'organizationInformations.logo.remoteFile.ino'
  | 'organizationInformations.logo.remoteFile.atimeMs'
  | 'organizationInformations.logo.remoteFile.mtimeMs'
  | 'organizationInformations.logo.remoteFile.ctimeMs'
  | 'organizationInformations.logo.remoteFile.atime'
  | 'organizationInformations.logo.remoteFile.mtime'
  | 'organizationInformations.logo.remoteFile.ctime'
  | 'organizationInformations.logo.remoteFile.birthtime'
  | 'organizationInformations.logo.remoteFile.birthtimeMs'
  | 'organizationInformations.logo.remoteFile.blksize'
  | 'organizationInformations.logo.remoteFile.blocks'
  | 'organizationInformations.logo.remoteFile.url'
  | 'organizationInformations.logo.remoteFile.publicURL'
  | 'organizationInformations.logo.remoteFile.childrenImageSharp'
  | 'organizationInformations.logo.remoteFile.id'
  | 'organizationInformations.logo.remoteFile.children'
  | 'organizationInformations.logo.localFile.sourceInstanceName'
  | 'organizationInformations.logo.localFile.absolutePath'
  | 'organizationInformations.logo.localFile.relativePath'
  | 'organizationInformations.logo.localFile.extension'
  | 'organizationInformations.logo.localFile.size'
  | 'organizationInformations.logo.localFile.prettySize'
  | 'organizationInformations.logo.localFile.modifiedTime'
  | 'organizationInformations.logo.localFile.accessTime'
  | 'organizationInformations.logo.localFile.changeTime'
  | 'organizationInformations.logo.localFile.birthTime'
  | 'organizationInformations.logo.localFile.root'
  | 'organizationInformations.logo.localFile.dir'
  | 'organizationInformations.logo.localFile.base'
  | 'organizationInformations.logo.localFile.ext'
  | 'organizationInformations.logo.localFile.name'
  | 'organizationInformations.logo.localFile.relativeDirectory'
  | 'organizationInformations.logo.localFile.dev'
  | 'organizationInformations.logo.localFile.mode'
  | 'organizationInformations.logo.localFile.nlink'
  | 'organizationInformations.logo.localFile.uid'
  | 'organizationInformations.logo.localFile.gid'
  | 'organizationInformations.logo.localFile.rdev'
  | 'organizationInformations.logo.localFile.ino'
  | 'organizationInformations.logo.localFile.atimeMs'
  | 'organizationInformations.logo.localFile.mtimeMs'
  | 'organizationInformations.logo.localFile.ctimeMs'
  | 'organizationInformations.logo.localFile.atime'
  | 'organizationInformations.logo.localFile.mtime'
  | 'organizationInformations.logo.localFile.ctime'
  | 'organizationInformations.logo.localFile.birthtime'
  | 'organizationInformations.logo.localFile.birthtimeMs'
  | 'organizationInformations.logo.localFile.blksize'
  | 'organizationInformations.logo.localFile.blocks'
  | 'organizationInformations.logo.localFile.url'
  | 'organizationInformations.logo.localFile.publicURL'
  | 'organizationInformations.logo.localFile.childrenImageSharp'
  | 'organizationInformations.logo.localFile.id'
  | 'organizationInformations.logo.localFile.children'
  | 'organizationInformations.logo.parent.id'
  | 'organizationInformations.logo.parent.children'
  | 'organizationInformations.logo.children'
  | 'organizationInformations.logo.children.id'
  | 'organizationInformations.logo.children.children'
  | 'organizationInformations.logo.internal.content'
  | 'organizationInformations.logo.internal.contentDigest'
  | 'organizationInformations.logo.internal.description'
  | 'organizationInformations.logo.internal.fieldOwners'
  | 'organizationInformations.logo.internal.ignoreType'
  | 'organizationInformations.logo.internal.mediaType'
  | 'organizationInformations.logo.internal.owner'
  | 'organizationInformations.logo.internal.type'
  | 'organizationInformations.name'
  | 'organizationInformations.url'
  | 'slug'
  | 'status'
  | 'template.templateName'
  | 'terms.nodes'
...
type WpOrganizationGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpOrganizationEdge>;
  readonly nodes: ReadonlyArray<WpOrganization>;
  readonly pageInfo: PageInfo;
...
type WpOrganizationGroupConnection_distinctArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationGroupConnection_maxArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationGroupConnection_minArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationGroupConnection_sumArgs = {
  field: WpOrganizationFieldsEnum;
};


type WpOrganizationGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpOrganizationFieldsEnum;
};

type WpOrganizationSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpOrganizationFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpOrganizationCategoryConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpOrganizationCategoryEdge>;
  readonly nodes: ReadonlyArray<WpOrganizationCategory>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpOrganizationCategoryGroupConnection>;
};


type WpOrganizationCategoryConnection_distinctArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryConnection_maxArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryConnection_minArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryConnection_sumArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpOrganizationCategoryFieldsEnum;
};

type WpOrganizationCategoryEdge = {
  readonly next: Maybe<WpOrganizationCategory>;
  readonly node: WpOrganizationCategory;
  readonly previous: Maybe<WpOrganizationCategory>;
};

type WpOrganizationCategoryFieldsEnum =
  | 'contentNodes.nodes'
  | 'contentNodes.nodes.contentTypeName'
  | 'contentNodes.nodes.databaseId'
  | 'contentNodes.nodes.date'
  ...
  | 'name'
  | 'organizations.nodes'
  | 'organizations.nodes.contentTypeName'
  | 'organizations.nodes.databaseId'
  | 'organizations.nodes.date'
  | 'organizations.nodes.dateGmt'
  | 'organizations.nodes.desiredSlug'
  | 'organizations.nodes.enclosure'
  | 'organizations.nodes.guid'
  | 'organizations.nodes.id'
  | 'organizations.nodes.isContentNode'
  | 'organizations.nodes.isTermNode'
  | 'organizations.nodes.link'
  | 'organizations.nodes.modified'
  | 'organizations.nodes.modifiedGmt'
  | 'organizations.nodes.organizationCategories.nodes'
  | 'organizations.nodes.organizationInformations.description'
  | 'organizations.nodes.organizationInformations.fieldGroupName'
  | 'organizations.nodes.organizationInformations.name'
  | 'organizations.nodes.organizationInformations.url'
  | 'organizations.nodes.slug'
  | 'organizations.nodes.status'
  | 'organizations.nodes.template.templateName'
  | 'organizations.nodes.terms.nodes'
  | 'organizations.nodes.title'
  | 'organizations.nodes.uri'
  | 'organizations.nodes.nodeType'
  | 'organizations.nodes.parent.id'
  | 'organizations.nodes.parent.children'
  | 'organizations.nodes.children'
  | 'organizations.nodes.children.id'
  | 'organizations.nodes.children.children'
  | 'organizations.nodes.internal.content'
  | 'organizations.nodes.internal.contentDigest'
  | 'organizations.nodes.internal.description'
  | 'organizations.nodes.internal.fieldOwners'
  | 'organizations.nodes.internal.ignoreType'
  | 'organizations.nodes.internal.mediaType'
  | 'organizations.nodes.internal.owner'
  | 'organizations.nodes.internal.type'
  | 'slug'
  | 'taxonomy.node.archivePath'
  | 'taxonomy.node.connectedContentTypes.nodes'
  | 'taxonomy.node.description'
...
type WpOrganizationCategoryGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpOrganizationCategoryEdge>;
  readonly nodes: ReadonlyArray<WpOrganizationCategory>;
  readonly pageInfo: PageInfo;
...
type WpOrganizationCategoryGroupConnection_distinctArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryGroupConnection_maxArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryGroupConnection_minArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryGroupConnection_sumArgs = {
  field: WpOrganizationCategoryFieldsEnum;
};


type WpOrganizationCategoryGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpOrganizationCategoryFieldsEnum;
};

type WpOrganizationCategorySortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpOrganizationCategoryFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpNewsItemConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpNewsItemEdge>;
  readonly nodes: ReadonlyArray<WpNewsItem>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpNewsItemGroupConnection>;
};


type WpNewsItemConnection_distinctArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemConnection_maxArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemConnection_minArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemConnection_sumArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpNewsItemFieldsEnum;
};
...
type WpNewsItemEdge = {
  readonly next: Maybe<WpNewsItem>;
  readonly node: WpNewsItem;
  readonly previous: Maybe<WpNewsItem>;
};

type WpNewsItemFieldsEnum =
  | 'attachments'
  | 'attachments.fileSizeHumanReadable'
  ...
  | 'newsCategories.nodes.ancestors.nodes'
  | 'newsCategories.nodes.wpChildren.nodes'
  | 'newsCategories.nodes.contentNodes.nodes'
  | 'newsCategories.nodes.count'
  | 'newsCategories.nodes.databaseId'
  | 'newsCategories.nodes.description'
  | 'newsCategories.nodes.id'
  | 'newsCategories.nodes.isContentNode'
  | 'newsCategories.nodes.isTermNode'
  | 'newsCategories.nodes.link'
  | 'newsCategories.nodes.name'
  | 'newsCategories.nodes.newsItems.nodes'
  | 'newsCategories.nodes.parentDatabaseId'
  | 'newsCategories.nodes.parentId'
  | 'newsCategories.nodes.slug'
  | 'newsCategories.nodes.taxonomyName'
  | 'newsCategories.nodes.termGroupId'
  | 'newsCategories.nodes.termTaxonomyId'
  | 'newsCategories.nodes.uri'
  | 'newsCategories.nodes.nodeType'
  | 'newsCategories.nodes.parent.id'
  | 'newsCategories.nodes.parent.children'
  | 'newsCategories.nodes.children'
  | 'newsCategories.nodes.children.id'
  | 'newsCategories.nodes.children.children'
  | 'newsCategories.nodes.internal.content'
  | 'newsCategories.nodes.internal.contentDigest'
  | 'newsCategories.nodes.internal.description'
  | 'newsCategories.nodes.internal.fieldOwners'
  | 'newsCategories.nodes.internal.ignoreType'
  | 'newsCategories.nodes.internal.mediaType'
  | 'newsCategories.nodes.internal.owner'
  | 'newsCategories.nodes.internal.type'
  | 'slug'
  | 'status'
  | 'tags.nodes'
  | 'tags.nodes.contentNodes.nodes'
...
type WpNewsItemGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpNewsItemEdge>;
  readonly nodes: ReadonlyArray<WpNewsItem>;
  readonly pageInfo: PageInfo;
...
type WpNewsItemGroupConnection_distinctArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemGroupConnection_maxArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemGroupConnection_minArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemGroupConnection_sumArgs = {
  field: WpNewsItemFieldsEnum;
};


type WpNewsItemGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpNewsItemFieldsEnum;
};

type WpNewsItemSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpNewsItemFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpNewsCategoryConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpNewsCategoryEdge>;
  readonly nodes: ReadonlyArray<WpNewsCategory>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpNewsCategoryGroupConnection>;
};


type WpNewsCategoryConnection_distinctArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryConnection_maxArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryConnection_minArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryConnection_sumArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpNewsCategoryFieldsEnum;
};

type WpNewsCategoryEdge = {
  readonly next: Maybe<WpNewsCategory>;
  readonly node: WpNewsCategory;
  readonly previous: Maybe<WpNewsCategory>;
};

type WpNewsCategoryFieldsEnum =
  | 'ancestors.nodes'
  | 'ancestors.nodes.ancestors.nodes'
  | 'ancestors.nodes.wpChildren.nodes'
  | 'ancestors.nodes.contentNodes.nodes'
  ...
  | 'ancestors.nodes.link'
  | 'ancestors.nodes.name'
  | 'ancestors.nodes.newsItems.nodes'
  | 'ancestors.nodes.parentDatabaseId'
  | 'ancestors.nodes.parentId'
  | 'ancestors.nodes.slug'
  | 'ancestors.nodes.taxonomyName'
  ...
  | 'wpChildren.nodes.link'
  | 'wpChildren.nodes.name'
  | 'wpChildren.nodes.newsItems.nodes'
  | 'wpChildren.nodes.parentDatabaseId'
  | 'wpChildren.nodes.parentId'
  | 'wpChildren.nodes.slug'
  | 'wpChildren.nodes.taxonomyName'
...
type WpNewsCategoryGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpNewsCategoryEdge>;
  readonly nodes: ReadonlyArray<WpNewsCategory>;
  readonly pageInfo: PageInfo;
...
type WpNewsCategoryGroupConnection_distinctArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryGroupConnection_maxArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryGroupConnection_minArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryGroupConnection_sumArgs = {
  field: WpNewsCategoryFieldsEnum;
};


type WpNewsCategoryGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpNewsCategoryFieldsEnum;
};

type WpNewsCategorySortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpNewsCategoryFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type WpLinkTreeItemToLinkTreeItemCategoryConnectionFilterInput = {
  readonly nodes: Maybe<WpLinkTreeItemCategoryFilterListInput>;
};

type WpLinkTreeItemCategoryFilterListInput = {
  readonly elemMatch: Maybe<WpLinkTreeItemCategoryFilterInput>;
};

type WpLinkTreeItemCategoryFilterInput = {
  readonly contentNodes: Maybe<WpLinkTreeItemCategoryToContentNodeConnectionFilterInput>;
  readonly count: Maybe<IntQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  ...
  readonly isTermNode: Maybe<BooleanQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly linkTreeItems: Maybe<WpLinkTreeItemCategoryToLinkTreeItemConnectionFilterInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly taxonomy: Maybe<WpLinkTreeItemCategoryToTaxonomyConnectionEdgeFilterInput>;
  readonly taxonomyName: Maybe<StringQueryOperatorInput>;
  readonly termGroupId: Maybe<IntQueryOperatorInput>;
  readonly termTaxonomyId: Maybe<IntQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
...
type WpLinkTreeItemCategoryToContentNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpContentNodeFilterListInput>;
};

type WpLinkTreeItemCategoryToLinkTreeItemConnectionFilterInput = {
  readonly nodes: Maybe<WpLinkTreeItemFilterListInput>;
};

type WpLinkTreeItemFilterListInput = {
  readonly elemMatch: Maybe<WpLinkTreeItemFilterInput>;
};

type WpLinkTreeItemFilterInput = {
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  readonly contentTypeName: Maybe<StringQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly date: Maybe<DateQueryOperatorInput>;
  ...
  readonly lastEditedBy: Maybe<WpContentNodeToEditLastConnectionEdgeFilterInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly linkTreeItemCategories: Maybe<WpLinkTreeItemToLinkTreeItemCategoryConnectionFilterInput>;
  readonly linkTreeItemInformation: Maybe<WpLinkTreeItem_LinktreeiteminformationFilterInput>;
  readonly modified: Maybe<DateQueryOperatorInput>;
  readonly modifiedGmt: Maybe<DateQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly terms: Maybe<WpLinkTreeItemToTermNodeConnectionFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
...
type WpLinkTreeItem_LinktreeiteminformationFilterInput = {
  readonly category: Maybe<WpLinkTreeItemCategoryFilterInput>;
  readonly fieldGroupName: Maybe<StringQueryOperatorInput>;
  readonly url: Maybe<StringQueryOperatorInput>;
  readonly urlText: Maybe<StringQueryOperatorInput>;
};

type WpLinkTreeItemToTermNodeConnectionFilterInput = {
  readonly nodes: Maybe<WpTermNodeFilterListInput>;
};

type WpLinkTreeItemCategoryToTaxonomyConnectionEdgeFilterInput = {
  readonly node: Maybe<WpTaxonomyFilterInput>;
};

type WpLinkTreeItemConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpLinkTreeItemEdge>;
  readonly nodes: ReadonlyArray<WpLinkTreeItem>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpLinkTreeItemGroupConnection>;
};


type WpLinkTreeItemConnection_distinctArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemConnection_maxArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemConnection_minArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemConnection_sumArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpLinkTreeItemFieldsEnum;
};

type WpLinkTreeItemEdge = {
  readonly next: Maybe<WpLinkTreeItem>;
  readonly node: WpLinkTreeItem;
  readonly previous: Maybe<WpLinkTreeItem>;
};

type WpLinkTreeItemFieldsEnum =
  | 'contentType.node.archivePath'
  | 'contentType.node.canExport'
  | 'contentType.node.connectedTaxonomies.nodes'
  | 'contentType.node.contentNodes.nodes'
  ...
  | 'lastEditedBy.node.internal.type'
  | 'link'
  | 'linkTreeItemCategories.nodes'
  | 'linkTreeItemCategories.nodes.contentNodes.nodes'
  | 'linkTreeItemCategories.nodes.count'
  | 'linkTreeItemCategories.nodes.databaseId'
  | 'linkTreeItemCategories.nodes.description'
  | 'linkTreeItemCategories.nodes.id'
  | 'linkTreeItemCategories.nodes.isContentNode'
  | 'linkTreeItemCategories.nodes.isTermNode'
  | 'linkTreeItemCategories.nodes.link'
  | 'linkTreeItemCategories.nodes.linkTreeItems.nodes'
  | 'linkTreeItemCategories.nodes.name'
  | 'linkTreeItemCategories.nodes.slug'
  | 'linkTreeItemCategories.nodes.taxonomyName'
  | 'linkTreeItemCategories.nodes.termGroupId'
  | 'linkTreeItemCategories.nodes.termTaxonomyId'
  | 'linkTreeItemCategories.nodes.uri'
  | 'linkTreeItemCategories.nodes.nodeType'
  | 'linkTreeItemCategories.nodes.parent.id'
  | 'linkTreeItemCategories.nodes.parent.children'
  | 'linkTreeItemCategories.nodes.children'
  | 'linkTreeItemCategories.nodes.children.id'
  | 'linkTreeItemCategories.nodes.children.children'
  | 'linkTreeItemCategories.nodes.internal.content'
  | 'linkTreeItemCategories.nodes.internal.contentDigest'
  | 'linkTreeItemCategories.nodes.internal.description'
  | 'linkTreeItemCategories.nodes.internal.fieldOwners'
  | 'linkTreeItemCategories.nodes.internal.ignoreType'
  | 'linkTreeItemCategories.nodes.internal.mediaType'
  | 'linkTreeItemCategories.nodes.internal.owner'
  | 'linkTreeItemCategories.nodes.internal.type'
  | 'linkTreeItemInformation.category.contentNodes.nodes'
  | 'linkTreeItemInformation.category.count'
  | 'linkTreeItemInformation.category.databaseId'
  | 'linkTreeItemInformation.category.description'
  | 'linkTreeItemInformation.category.id'
  | 'linkTreeItemInformation.category.isContentNode'
  | 'linkTreeItemInformation.category.isTermNode'
  | 'linkTreeItemInformation.category.link'
  | 'linkTreeItemInformation.category.linkTreeItems.nodes'
  | 'linkTreeItemInformation.category.name'
  | 'linkTreeItemInformation.category.slug'
  | 'linkTreeItemInformation.category.taxonomyName'
  | 'linkTreeItemInformation.category.termGroupId'
  | 'linkTreeItemInformation.category.termTaxonomyId'
  | 'linkTreeItemInformation.category.uri'
  | 'linkTreeItemInformation.category.nodeType'
  | 'linkTreeItemInformation.category.parent.id'
  | 'linkTreeItemInformation.category.parent.children'
  | 'linkTreeItemInformation.category.children'
  | 'linkTreeItemInformation.category.children.id'
  | 'linkTreeItemInformation.category.children.children'
  | 'linkTreeItemInformation.category.internal.content'
  | 'linkTreeItemInformation.category.internal.contentDigest'
  | 'linkTreeItemInformation.category.internal.description'
  | 'linkTreeItemInformation.category.internal.fieldOwners'
  | 'linkTreeItemInformation.category.internal.ignoreType'
  | 'linkTreeItemInformation.category.internal.mediaType'
  | 'linkTreeItemInformation.category.internal.owner'
  | 'linkTreeItemInformation.category.internal.type'
  | 'linkTreeItemInformation.fieldGroupName'
  | 'linkTreeItemInformation.url'
  | 'linkTreeItemInformation.urlText'
  | 'modified'
  | 'modifiedGmt'
  | 'slug'
  | 'status'
...
type WpLinkTreeItemGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpLinkTreeItemEdge>;
  readonly nodes: ReadonlyArray<WpLinkTreeItem>;
  readonly pageInfo: PageInfo;
...
type WpLinkTreeItemGroupConnection_distinctArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemGroupConnection_maxArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemGroupConnection_minArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemGroupConnection_sumArgs = {
  field: WpLinkTreeItemFieldsEnum;
};


type WpLinkTreeItemGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpLinkTreeItemFieldsEnum;
};

type WpLinkTreeItemSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpLinkTreeItemFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type WpLinkTreeItemCategoryConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpLinkTreeItemCategoryEdge>;
  readonly nodes: ReadonlyArray<WpLinkTreeItemCategory>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpLinkTreeItemCategoryGroupConnection>;
};


type WpLinkTreeItemCategoryConnection_distinctArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryConnection_maxArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryConnection_minArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryConnection_sumArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpLinkTreeItemCategoryFieldsEnum;
};

type WpLinkTreeItemCategoryEdge = {
  readonly next: Maybe<WpLinkTreeItemCategory>;
  readonly node: WpLinkTreeItemCategory;
  readonly previous: Maybe<WpLinkTreeItemCategory>;
};

type WpLinkTreeItemCategoryFieldsEnum =
  | 'contentNodes.nodes'
  | 'contentNodes.nodes.contentTypeName'
  | 'contentNodes.nodes.databaseId'
  | 'contentNodes.nodes.date'
  ...
  | 'link'
  | 'linkTreeItems.nodes'
  | 'linkTreeItems.nodes.contentTypeName'
  | 'linkTreeItems.nodes.databaseId'
  | 'linkTreeItems.nodes.date'
  | 'linkTreeItems.nodes.dateGmt'
  | 'linkTreeItems.nodes.desiredSlug'
  | 'linkTreeItems.nodes.enclosure'
  | 'linkTreeItems.nodes.featuredImageDatabaseId'
  | 'linkTreeItems.nodes.featuredImageId'
  | 'linkTreeItems.nodes.guid'
  | 'linkTreeItems.nodes.id'
  | 'linkTreeItems.nodes.isContentNode'
  | 'linkTreeItems.nodes.isTermNode'
  | 'linkTreeItems.nodes.link'
  | 'linkTreeItems.nodes.linkTreeItemCategories.nodes'
  | 'linkTreeItems.nodes.linkTreeItemInformation.fieldGroupName'
  | 'linkTreeItems.nodes.linkTreeItemInformation.url'
  | 'linkTreeItems.nodes.linkTreeItemInformation.urlText'
  | 'linkTreeItems.nodes.modified'
  | 'linkTreeItems.nodes.modifiedGmt'
  | 'linkTreeItems.nodes.slug'
  | 'linkTreeItems.nodes.status'
  | 'linkTreeItems.nodes.template.templateName'
  | 'linkTreeItems.nodes.terms.nodes'
  | 'linkTreeItems.nodes.title'
  | 'linkTreeItems.nodes.uri'
  | 'linkTreeItems.nodes.nodeType'
  | 'linkTreeItems.nodes.parent.id'
  | 'linkTreeItems.nodes.parent.children'
  | 'linkTreeItems.nodes.children'
  | 'linkTreeItems.nodes.children.id'
  | 'linkTreeItems.nodes.children.children'
  | 'linkTreeItems.nodes.internal.content'
  | 'linkTreeItems.nodes.internal.contentDigest'
  | 'linkTreeItems.nodes.internal.description'
  | 'linkTreeItems.nodes.internal.fieldOwners'
  | 'linkTreeItems.nodes.internal.ignoreType'
  | 'linkTreeItems.nodes.internal.mediaType'
  | 'linkTreeItems.nodes.internal.owner'
  | 'linkTreeItems.nodes.internal.type'
  | 'name'
  | 'slug'
  | 'taxonomy.node.archivePath'
  | 'taxonomy.node.connectedContentTypes.nodes'
...
type WpLinkTreeItemCategoryGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpLinkTreeItemCategoryEdge>;
  readonly nodes: ReadonlyArray<WpLinkTreeItemCategory>;
  readonly pageInfo: PageInfo;
...
type WpLinkTreeItemCategoryGroupConnection_distinctArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryGroupConnection_maxArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryGroupConnection_minArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryGroupConnection_sumArgs = {
  field: WpLinkTreeItemCategoryFieldsEnum;
};


type WpLinkTreeItemCategoryGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpLinkTreeItemCategoryFieldsEnum;
};

type WpLinkTreeItemCategorySortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpLinkTreeItemCategoryFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type WpTeaser_TeaserinformationsFilterInput = {
...
type WpTeaserConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<WpTeaserEdge>;
  readonly nodes: ReadonlyArray<WpTeaser>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<WpTeaserGroupConnection>;
};


type WpTeaserConnection_distinctArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserConnection_maxArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserConnection_minArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserConnection_sumArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpTeaserFieldsEnum;
};
...
type WpTeaserEdge = {
  readonly next: Maybe<WpTeaser>;
  readonly node: WpTeaser;
  readonly previous: Maybe<WpTeaser>;
};

type WpTeaserFieldsEnum =
  | 'contentType.node.archivePath'
  | 'contentType.node.canExport'
  | 'contentType.node.connectedTaxonomies.nodes'
  | 'contentType.node.contentNodes.nodes'
  ...
  | 'slug'
  | 'status'
  | 'teaserInformations.buttonText'
  | 'teaserInformations.fieldGroupName'
  | 'teaserInformations.image.altText'
  | 'teaserInformations.image.ancestors.nodes'
  | 'teaserInformations.image.authorDatabaseId'
  | 'teaserInformations.image.authorId'
  | 'teaserInformations.image.caption'
  | 'teaserInformations.image.wpChildren.nodes'
  | 'teaserInformations.image.commentCount'
  | 'teaserInformations.image.commentStatus'
  | 'teaserInformations.image.comments.nodes'
  | 'teaserInformations.image.contentTypeName'
  | 'teaserInformations.image.databaseId'
  | 'teaserInformations.image.date'
  | 'teaserInformations.image.dateGmt'
  | 'teaserInformations.image.description'
  | 'teaserInformations.image.desiredSlug'
  | 'teaserInformations.image.enclosure'
  | 'teaserInformations.image.fileSize'
  | 'teaserInformations.image.guid'
  | 'teaserInformations.image.id'
  | 'teaserInformations.image.isContentNode'
  | 'teaserInformations.image.isTermNode'
  | 'teaserInformations.image.link'
  | 'teaserInformations.image.mediaDetails.file'
  | 'teaserInformations.image.mediaDetails.height'
  | 'teaserInformations.image.mediaDetails.sizes'
  | 'teaserInformations.image.mediaDetails.width'
  | 'teaserInformations.image.mediaItemUrl'
  | 'teaserInformations.image.mediaType'
  | 'teaserInformations.image.mimeType'
  | 'teaserInformations.image.modified'
  | 'teaserInformations.image.modifiedGmt'
  | 'teaserInformations.image.parentDatabaseId'
  | 'teaserInformations.image.parentId'
  | 'teaserInformations.image.sizes'
  | 'teaserInformations.image.slug'
  | 'teaserInformations.image.sourceUrl'
  | 'teaserInformations.image.srcSet'
  | 'teaserInformations.image.status'
  | 'teaserInformations.image.template.templateName'
  | 'teaserInformations.image.title'
  | 'teaserInformations.image.uri'
  | 'teaserInformations.image.nodeType'
  | 'teaserInformations.image.remoteFile.sourceInstanceName'
  | 'teaserInformations.image.remoteFile.absolutePath'
  | 'teaserInformations.image.remoteFile.relativePath'
  | 'teaserInformations.image.remoteFile.extension'
  | 'teaserInformations.image.remoteFile.size'
  | 'teaserInformations.image.remoteFile.prettySize'
  | 'teaserInformations.image.remoteFile.modifiedTime'
  | 'teaserInformations.image.remoteFile.accessTime'
  | 'teaserInformations.image.remoteFile.changeTime'
  | 'teaserInformations.image.remoteFile.birthTime'
  | 'teaserInformations.image.remoteFile.root'
  | 'teaserInformations.image.remoteFile.dir'
  | 'teaserInformations.image.remoteFile.base'
  | 'teaserInformations.image.remoteFile.ext'
  | 'teaserInformations.image.remoteFile.name'
  | 'teaserInformations.image.remoteFile.relativeDirectory'
  | 'teaserInformations.image.remoteFile.dev'
  | 'teaserInformations.image.remoteFile.mode'
  | 'teaserInformations.image.remoteFile.nlink'
  | 'teaserInformations.image.remoteFile.uid'
  | 'teaserInformations.image.remoteFile.gid'
  | 'teaserInformations.image.remoteFile.rdev'
  | 'teaserInformations.image.remoteFile.ino'
  | 'teaserInformations.image.remoteFile.atimeMs'
  | 'teaserInformations.image.remoteFile.mtimeMs'
  | 'teaserInformations.image.remoteFile.ctimeMs'
  | 'teaserInformations.image.remoteFile.atime'
  | 'teaserInformations.image.remoteFile.mtime'
  | 'teaserInformations.image.remoteFile.ctime'
  | 'teaserInformations.image.remoteFile.birthtime'
  | 'teaserInformations.image.remoteFile.birthtimeMs'
  | 'teaserInformations.image.remoteFile.blksize'
  | 'teaserInformations.image.remoteFile.blocks'
  | 'teaserInformations.image.remoteFile.url'
  | 'teaserInformations.image.remoteFile.publicURL'
  | 'teaserInformations.image.remoteFile.childrenImageSharp'
  | 'teaserInformations.image.remoteFile.id'
  | 'teaserInformations.image.remoteFile.children'
  | 'teaserInformations.image.localFile.sourceInstanceName'
  | 'teaserInformations.image.localFile.absolutePath'
  | 'teaserInformations.image.localFile.relativePath'
  | 'teaserInformations.image.localFile.extension'
  | 'teaserInformations.image.localFile.size'
  | 'teaserInformations.image.localFile.prettySize'
  | 'teaserInformations.image.localFile.modifiedTime'
  | 'teaserInformations.image.localFile.accessTime'
  | 'teaserInformations.image.localFile.changeTime'
  | 'teaserInformations.image.localFile.birthTime'
  | 'teaserInformations.image.localFile.root'
  | 'teaserInformations.image.localFile.dir'
  | 'teaserInformations.image.localFile.base'
  | 'teaserInformations.image.localFile.ext'
  | 'teaserInformations.image.localFile.name'
  | 'teaserInformations.image.localFile.relativeDirectory'
  | 'teaserInformations.image.localFile.dev'
  | 'teaserInformations.image.localFile.mode'
  | 'teaserInformations.image.localFile.nlink'
  | 'teaserInformations.image.localFile.uid'
  | 'teaserInformations.image.localFile.gid'
  | 'teaserInformations.image.localFile.rdev'
  | 'teaserInformations.image.localFile.ino'
  | 'teaserInformations.image.localFile.atimeMs'
  | 'teaserInformations.image.localFile.mtimeMs'
  | 'teaserInformations.image.localFile.ctimeMs'
  | 'teaserInformations.image.localFile.atime'
  | 'teaserInformations.image.localFile.mtime'
  | 'teaserInformations.image.localFile.ctime'
  | 'teaserInformations.image.localFile.birthtime'
  | 'teaserInformations.image.localFile.birthtimeMs'
  | 'teaserInformations.image.localFile.blksize'
  | 'teaserInformations.image.localFile.blocks'
  | 'teaserInformations.image.localFile.url'
  | 'teaserInformations.image.localFile.publicURL'
  | 'teaserInformations.image.localFile.childrenImageSharp'
  | 'teaserInformations.image.localFile.id'
  | 'teaserInformations.image.localFile.children'
  | 'teaserInformations.image.parent.id'
  | 'teaserInformations.image.parent.children'
  | 'teaserInformations.image.children'
  | 'teaserInformations.image.children.id'
  | 'teaserInformations.image.children.children'
  | 'teaserInformations.image.internal.content'
  | 'teaserInformations.image.internal.contentDigest'
  | 'teaserInformations.image.internal.description'
  | 'teaserInformations.image.internal.fieldOwners'
  | 'teaserInformations.image.internal.ignoreType'
  | 'teaserInformations.image.internal.mediaType'
  | 'teaserInformations.image.internal.owner'
  | 'teaserInformations.image.internal.type'
  | 'teaserInformations.pagePath'
  | 'template.templateName'
  | 'title'
  | 'uri'
  | 'nodeType'
...
type WpTeaserGroupConnection_distinctArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserGroupConnection_maxArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserGroupConnection_minArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserGroupConnection_sumArgs = {
  field: WpTeaserFieldsEnum;
};


type WpTeaserGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: WpTeaserFieldsEnum;
};

type WpTeaserFilterInput = {
  readonly contentType: Maybe<WpContentNodeToContentTypeConnectionEdgeFilterInput>;
  readonly contentTypeName: Maybe<StringQueryOperatorInput>;
  readonly databaseId: Maybe<IntQueryOperatorInput>;
  readonly date: Maybe<DateQueryOperatorInput>;
  ...
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly status: Maybe<StringQueryOperatorInput>;
  readonly teaserInformations: Maybe<WpTeaser_TeaserinformationsFilterInput>;
  readonly template: Maybe<WpContentTemplateFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly uri: Maybe<StringQueryOperatorInput>;
  readonly nodeType: Maybe<StringQueryOperatorInput>;
...
type WpTeaserSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<WpTeaserFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type LandingPageQueryVariables = Exact<{ [key: string]: never; }>;


type LandingPageQuery = { readonly HeroImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly MaedchenImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly MintmachenImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly MintvernetztImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly MintcommunityImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly newsItems: { readonly nodes: ReadonlyArray<(
      Pick<WpNewsItem, 'title' | 'excerpt' | 'slug' | 'date'>
      & { readonly tags: Maybe<{ readonly nodes: Maybe<ReadonlyArray<Maybe<Pick<WpTag, 'name' | 'slug'>>>> }> }
    )> }, readonly organizationsData: { readonly nodes: ReadonlyArray<{ readonly organizationInformations: Maybe<(
        Pick<WpOrganization_Organizationinformations, 'name' | 'description' | 'url'>
        & { readonly logo: Maybe<(
          Pick<WpMediaItem, 'altText'>
          & { readonly localFile: Maybe<Pick<File, 'publicURL'>> }
        )> }
      )> }> }, readonly events: { readonly nodes: ReadonlyArray<(
      Pick<WpEvent, 'excerpt' | 'title' | 'slug'>
      & { readonly eventInformations: Maybe<Pick<WpEvent_Eventinformations, 'startTime' | 'startDate' | 'endTime' | 'endDate'>> }
    )> }, readonly teasers: { readonly nodes: ReadonlyArray<(
      Pick<WpTeaser, 'title' | 'excerpt'>
      & { readonly teaserInformations: Maybe<(
        Pick<WpTeaser_Teaserinformations, 'buttonText' | 'pagePath'>
        & { readonly image: Maybe<{ readonly localFile: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }>, readonly post: Maybe<ReadonlyArray<Maybe<(
          { readonly __typename: 'WpNewsItem' }
          & Pick<WpNewsItem, 'id' | 'slug'>
          & { readonly featuredImage: Maybe<{ readonly node: Maybe<{ readonly localFile: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }> }> }
        ) | (
          { readonly __typename: 'WpEvent' }
          & Pick<WpEvent, 'id' | 'slug'>
          & { readonly featuredImage: Maybe<{ readonly node: Maybe<{ readonly localFile: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }> }> }
        )>>> }
      )> }
    )> } };
...
type Unnamed_1_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl'>> }>, readonly favicon: Maybe<Pick<File, 'publicURL'>>, readonly social: Maybe<Pick<File, 'publicURL'>> };
