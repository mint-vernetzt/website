    ...
    <div className="max-w-sm">
      ...
      <main className="flex-1 pb-10">
        <div className="container mt-8 mb-6">
          <Link
            to="/"
            className="text-sm font-semibold text-primary block text-center"
          >
        ...
        <div className="container pt-6">
          <div className="">
            <div className="">
              <H4 className="text-base text-gray-600 font-bold mb-3">
                Ihr wollt informiert bleiben?
              </H4>
              <ul className="flex -mx-2 text-sm">
                {[
                  {
                    icon: (
                      <svg
                  ...
                  <li
                    key={`nav-item-${index}`}
                    className="px-2 flex-1/2 mb-4 items-center"
                  >
                    <a
            ...
            <div className="mt-2">
              ...
              <ul className="flex text-sm flex-wrap -mx-2">
                {[
                  {
                    icon: (
                      <svg
      ...
      <footer>
        <div className="footer-section py-4 border-t border-neutral-400 overflow-hidden">
          <div className="container">
            <div className="flex flex-wrap">
              ...
              <div className="flex-100 pt-6 flex flex-wrap">
                <ul className="flex-100 pb-2 mb-0 meta_nav text-neutral-600 text-sm leading-4 font-semibold">
                  {[
                    {
                      route: `/imprint/`,
                      title: `Impressum`,
                    ...
                    <li key={`nav-item-${index}`} className="pb-4">
              ...
              <div className="pb-4 logo-bmbf">
                <a href="https://www.bmbf.de/" target="_blank">
                  ...
                  >
                    <title id="bmbf-title">
                      Logo: Gefördert vom Bundesministerium für Bildung und
                      Forschung
                    </title>
                    <g fillRule="nonzero" fill="none">
                      <path
