      ...
      <section className="container mt-8 md:mb-10 lg:mt-10 mb-8 lg:mb-20">
        <div className="flex flex-wrap md:flex-nowrap md:-mx-4 my-10">
          ...
          <header className="text-left">
              <H1 like="h2" className="font-bold">News eintragen</H1>
              <p className="text-md">
            ...
            {isSubmitted !== true && (
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <H5 className="font-bold mb-4">Nur für das MINTvernetzt Team sichtbar</H5>
                <FormRow>
                ...
                <FormRowCheckbox>
                  <FormLabel htmlFor="terms_accepted">
                    ...
                    />
                    <span className="label-text">Ich stimme der Verwendung meiner eingegebnenen Daten
                    entsprechend der Datenschutzerklärung zu</span>
                  </FormLabel>                  
                </FormRowCheckbox>
              ...
              <div className="contact-card">
                ...
                <div className="">
                  <p className="text-mb text-neutral-800 mb-2">
                    <a href="anna.schroeter@mint-vernetzt.de" className="flex items-center px-4 py-3 bg-neutral-300">
                  ...
                  <p className="text-md text-neutral-800 mb-2">
                    <a href="492117570762" className="flex items-center px-4 py-3 bg-neutral-300">
                      <span className="icon w-4 h-4 mr-3">
