...
export function Diversity({ data }: { data: GatsbyTypes.DiversityPageQuery }) {
  const now = new Date();
          ...
          <GatsbyImage
            image={
              event?.featuredImage?.node?.localFile?.childImageSharp
                ?.gatsbyImageData ??
              data?.StudyImage?.childImageSharp?.gatsbyImageData
            }
  ...
  const projectslides = [
    {
      ...
      projectinfo: (
        <p>
          Little Lab setzt sich dafür ein allen Kindern Naturwissenschaften,
          Technik und Informatik in kreativen, lustigen und praktischen
          Experimenten nahe zu bringen. Insbesondere spricht Little Lab Kinder
          an, die aus unterschiedlichen Gründen einen weiteren Weg zu guter
          Bildung haben – mit dem Ziel, dass alle Kinder die MINT-Fächer nicht
          nur verstehen, sondern auch lieben.
        </p>
      ),
      projectproblems: (
        <ul>
          <li>
            Die Zielgruppe – Kinder im Kita- und Grundschulalter vor allem aus
            benachteiligten Milieus – um Jugendliche aus gleichen Milieus
            erweitern. Sie nehmen kaum offene außerschulische Angebote in ihrer
            Freizeit wahr.
          </li>
        </ul>
      ),
      communityvalue: (
        <ul>
          <li>
            Kooperationen mit Ganztagsschulen: Schul-AGs, Projekte außerhalb der
            Schule, aber mit Anmeldung für Gruppen.
          </li>
          <li>Kooperationen mit Jugendtreffs.</li>
          <li>Leichte Sprache in der Kommunikation der Angebote.</li>
          <li>
            Angebote und Inhalte, die an die Zielgruppen angepasst sind (selbst
            machbar, kreativ, alltagsbezogen).
          </li>
          <li>
    ...
    },
    {
      ...
      projectinfo: (
        <p>
          Das Schülerforschungszentrum Nordhausen schafft außerschulische
          MINT-Bildungsangebote in der Region Nordthüringen. Dabei ist dem Team
          besonders wichtig, dass alle Kinder und Jugendlichen, die sich für
          MINT-Themen interessieren, an den Angeboten teilnehmen können.
        </p>
      ),
      projectproblems: (
        <ul>
      ...
      communityvalue: (
        <ul>
          <li>
            Überarbeitung von niedrigschwelligen Experimenten im Projekt
            „Inklusiver Forschernachmittag". Dabei wurde darauf geachtet, dass
            Anleitungen in einfacher Sprache bebildert sind und Materialien für
            motorische Einschränkungen sowie barrierefreie Räumlichkeiten
            bereitgestellt sind.
          </li>
          <li>Zusammenarbeit mit Studierenden der Heilpädagogik.</li>
          <li>
            Enge Zusammenarbeit mit dem Inklusionsnetzwerk Nordhausen und der
            offenen Jugendarbeit. Tipp: Netzwerke und Partner:innen suchen, die
            unterstützen können und an Kooperationen interessiert sind.{" "}
          </li>
        </ul>
      ),
    ...
    },
    {
      ...
      projectinfo: (
        <p>
          meerMINT ist ein Projekt, in dem MINT für Kinder und Jugendlichen
          zwischen 10 und 16 Jahren in Bremen und Bremerhaven erlebbar wird. Es
          wird gemeinsam getüftelt, programmiert, geforscht, experimentiert und
          gebastelt. meerMINT ist eins von 53 regionalen MINT-Clustern, die
          aktuell vom Bundesministerium für Bildung und Forschung (BMBF)
          gefördert werden.
        </p>
      ),
      projectproblems: (
        <ul>
          <li>
            Erreichbarkeit einer diversen Zielgruppe geht nur langsam voran,
            bildungsnahe Familien kommen am ehesten.
          </li>
          <li>Räume sind nicht barrierefrei und schwierig umzubauen.</li>
          <li>
            Sprachliche Barrieren bleiben, auch wenn bereits einige
            Mitarbeitende mit verschiedenen Sprachkenntnissen vor Ort arbeiten.
          </li>
        </ul>
      ),
      communityvalue: (
        <ul>
          <li>
            meerMINT geht mit den Angeboten dorthin, wo die jungen Menschen
            sind, insbesondere Mädchen-/Jugendtreffs und Stadtteilbibliotheken,
            dies bringt das Projekt näher an die Zielgruppe.
          </li>
          <li>
            meerMINT versucht, auch andere Sprachen über die Mitarbeitenden in
            die Veranstaltungen zu bringen z.B. über internationale Studierende.
          </li>
        </ul>
      ),
        ...
        <div className="container flex justify-center">
          <div className="lg:w-10/12">
            ...
            <p className="text-3xl leading-snug text-primary font-semibold">
              ...
              – aber wie stellen wir das an? Auf dieser Themenseite bündeln wir
          ...
          <div className="md:flex md:items-center md:justify-center -mx-4">
            <div className="md:w-4/12 px-4 mb-8 md:mb-0">
              ...
              <p className="lg:text-xl leading-snug text-neutral-700">
                ...
                Wohlstand und Innovation in Deutschland zu erhalten.
              </p>
            </div>
            <div className="md:w-8/12 xl:w-6/12 px-4">
              ...
              >
                <iframe
                  ...
                  allow="autoplay"
                ></iframe>
                <div id={`keynote-optin`} className="flex p-8">
        ...
        <div className="container">
          <div className="md:flex md:items-center -mx-4">
            ...
            <div className="md:w-6/12 lg:w-4/12 px-4">
              ...
              <p>
                <a
                  href="/data/daten-fakten#mint-studie-diversitaet"
      ...
      <section className="bg-beige-500 pt-16 pb-28 lg:pt-24 lg:pb-40 relative">
        <div className="absolute inset-0 z-10 overflow-hidden flex items-center justify-center text-salmon-500">
          <svg
            ...
            fill="none"
            viewBox="0 0 784 649"
            className="absolute w-[100%] rotate-[10deg] aspect-[1.2]"
          >
            <path
              stroke="currentColor"
              stroke-width="3"
        ...
        <div className="container">
          <div className="md:flex md:items-center -mx-4">
            ...
            <div className="md:w-6/12 lg:w-4/12 px-4 mb-8 md:mb-0">
              ...
              <p className="mb-0">
                <Link to="/topics/diversitaet_glossar" className="btn-primary">
                  Zum Glossar
                </Link>
              </p>
            </div>
