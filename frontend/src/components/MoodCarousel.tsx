...
export function MoodCarousel(props: MoodCarouselProps) {
  ...
  return (
    <>
      ...
      <div className="prev-slide h-full absolute left-0.5 md:-left-10 lg:-left-16 top-0 w-10 lg:w-16 flex items-center z-10 md:pl-2 lg:pl-6 hover:text-blue-400">
        <svg
      ...
      <div className="next-slide h-full absolute right-0.5 md:-right-10 lg:-right-16 top-0 w-10 lg:w-16 flex justify-end items-center z-10 md:pr-2 lg:pr-6 hover:text-blue-400">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
          height="33"
