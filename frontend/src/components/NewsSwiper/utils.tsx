...
import { NewsSwiperItemProps } from "./NewsSwiperItem";
...
export interface GetNewsSwiperItemPropsOptions {
  numberOfTags?: number;
  withImage?: boolean;
}

export function getNewsSwiperItemProps(
  options?: GetNewsSwiperItemPropsOptions
): NewsSwiperItemProps {
  const {
